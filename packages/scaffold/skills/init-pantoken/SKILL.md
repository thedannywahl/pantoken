...
editor/agent rule files (Cursor, Copilot, Windsurf), and the `create-pantoken-app` and
`create-pantoken-mockup` skills.
...
directly), and use `create-pantoken-mockup` for a standalone browser or email artifact.
