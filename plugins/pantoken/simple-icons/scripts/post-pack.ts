 ...
 * The barrel `simple-icons.css` is a tsdown entry; the per-icon files are pre-built and copied.
 */
...
console.log(`✓ simple-icons: copied per-icon CSS files to dist/icons/`);
