...
- f475012: Upgrade the vendored Instructure design tokens to v2.0.0 and retire the six compatibility shims whose upstream removal milestones were reached.
...
- db34dec: fix(core): keep upstream token assets available to `buildTokens`
...
- db34dec: fix(core): keep the GitHub-only design-tokens dependency out of downstream consumers
