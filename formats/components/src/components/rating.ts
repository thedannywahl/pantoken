 ...
 * @example
 * <span class="${p}rating -size-sm" role="img" aria-label="2 out of 3 stars">
 *   <span class="${p}icon -icon-star-solid"></span> <span class="${p}icon -icon-star-solid"></span> <span class="${p}icon -icon-star"></span>
