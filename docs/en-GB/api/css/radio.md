...
- [checkbox](/en-GB/api/css/checkbox.md) — The multi-select counterpart to a single-select radio.
- [radio-input-group](/en-GB/api/css/radio-input-group.md) — Collects radios into one single-select fieldset.
