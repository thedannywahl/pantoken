...
- [heading](/en-GB/api/css/heading.md) — Typography for headings rather than body text.
- [truncate](/en-GB/api/css/truncate.md) — Clips this text to one line or a set number of lines.
