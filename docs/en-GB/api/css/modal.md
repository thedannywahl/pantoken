...
- [modal.body](/en-GB/api/css/modal.body.md)
- [modal.footer](/en-GB/api/css/modal.footer.md)
- [modal.header](/en-GB/api/css/modal.header.md)

## Related

- [tray](/en-GB/api/css/tray.md) — A tray is the same dismissible overlay pattern, anchored to a screen edge.
