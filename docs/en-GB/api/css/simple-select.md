...
- [text-input](/en-GB/api/css/text-input.md) — Shares the same field chrome, states, and sizes.
- [menu](/en-GB/api/css/menu.md) — The dropdown surface a richer select reuses.
