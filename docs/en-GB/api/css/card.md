...
- [heading](/en-GB/api/css/heading.md) — Place directly in the card or inside a container section.
- [button](/en-GB/api/css/button.md) — Place directly in the card or inside a container section.
- [img](/en-GB/api/css/img.md) — Place directly in the card as a media region.
- [badge](/en-GB/api/css/badge.md) — Place directly in the card as a status indicator.
