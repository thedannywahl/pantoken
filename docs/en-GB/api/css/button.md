...
| `.-color-primary-inverse` | <span class="instui-pill -color-danger pantoken-doc-tag">Deprecated</span> — use `.-on-color`. |
...
- [close-button](/en-GB/api/css/close-button.md) — The icon-only dismiss button.
