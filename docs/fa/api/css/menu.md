...
- [menu.group](/fa/api/css/menu.group.md)
- [menu.item](/fa/api/css/menu.item.md)
- [menu.separator](/fa/api/css/menu.separator.md)
- [side-nav-bar.item](/fa/api/css/side-nav-bar.item.md)

## مرتبط

- [tree-browser](/fa/api/css/tree-browser.md) — Both present nested, selectable entries.
- [simple-select](/fa/api/css/simple-select.md) — A select's dropdown reuses this menu surface.
