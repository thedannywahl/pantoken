...
| `.-render-icon-<name>` | <span class="instui-pill -color-danger pantoken-doc-tag">منسوخ</span> — The former `renderIcon` prop; still works as an alias, but use `-icon-<name>` instead. |
...
- [badge](/fa/api/css/badge.md) — A badge is the count or notification counterpart.
- [tag](/fa/api/css/tag.md) — A tag is the removable, form-oriented counterpart.
