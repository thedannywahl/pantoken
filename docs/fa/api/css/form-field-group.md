...
- [form-field](/fa/api/css/form-field.md)
- [form-field-messages](/fa/api/css/form-field-messages.md)

## مرتبط

- [form-field](/fa/api/css/form-field.md) — The single field this group repeats.
- [radio-input-group](/fa/api/css/radio-input-group.md) — Groups radio inputs under a legend.
