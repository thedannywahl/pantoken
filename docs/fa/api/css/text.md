...
| تعدیل‌کننده | توضیحات |
| --- | --- |
| `.-color-ai` | <span class="instui-pill -color-danger pantoken-doc-tag">منسوخ</span> — use `.-color-ai-highlight`. |
...
- [heading](/fa/api/css/heading.md) — Typography for headings rather than body text.
- [truncate](/fa/api/css/truncate.md) — Clips this text to one line or a set number of lines.
