...
- [table.body](/fa/api/css/table.body.md)
- [table.cell](/fa/api/css/table.cell.md)
- [table.col-header](/fa/api/css/table.col-header.md)
- [table.head](/fa/api/css/table.head.md)
- [table.row](/fa/api/css/table.row.md)
- [table.row-header](/fa/api/css/table.row-header.md)
