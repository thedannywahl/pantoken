...
- [form-field-messages](/fa/api/css/form-field-messages.md)
- [text-input](/fa/api/css/text-input.md)

## مرتبط

- [form-field-messages](/fa/api/css/form-field-messages.md) — Renders the field's hint, error, and success messages.
- [form-field-group](/fa/api/css/form-field-group.md) — Groups related fields under a shared legend.
