...
- [drawer-layout.tray](/fa/api/css/drawer-layout.tray.md)
- [tray](/fa/api/css/tray.md)

## مرتبط

- [tray](/fa/api/css/tray.md) — A standalone edge overlay; this layout keeps tray and content in the same flow.
- [context-view](/fa/api/css/context-view.md) — A smaller anchored surface for contextual actions and detail.
