...
- [modal.body](/fa/api/css/modal.body.md)
- [modal.footer](/fa/api/css/modal.footer.md)
- [modal.header](/fa/api/css/modal.header.md)

## مرتبط

- [tray](/fa/api/css/tray.md) — A tray is the same dismissible overlay pattern, anchored to a screen edge.
