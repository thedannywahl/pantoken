...
| `.-size-regular` | <span class="instui-pill -color-danger pantoken-doc-tag">منسوخ</span> — use `.-size-md`. |
| `.-size-sm` | Small. |
...
- [modal](/fa/api/css/modal.md) — The same dismissible overlay pattern, centred instead of edge-pinned.
- [popover](/fa/api/css/popover.md) — The generic top-layer surface this builds on.
