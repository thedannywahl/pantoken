...
- [heading](/fa/api/css/heading.md) — Place directly in the card or inside a container section.
- [button](/fa/api/css/button.md) — Place directly in the card or inside a container section.
- [img](/fa/api/css/img.md) — Place directly in the card as a media region.
- [badge](/fa/api/css/badge.md) — Place directly in the card as a status indicator.
