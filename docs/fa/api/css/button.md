...
| `.-color-primary-inverse` | <span class="instui-pill -color-danger pantoken-doc-tag">منسوخ</span> — use `.-on-color`. |
...
- [close-button](/fa/api/css/close-button.md) — The icon-only dismiss button.
