...
- [menu.group](/nl/api/css/menu.group.md)
- [menu.item](/nl/api/css/menu.item.md)
- [menu.separator](/nl/api/css/menu.separator.md)
- [side-nav-bar.item](/nl/api/css/side-nav-bar.item.md)

## Gerelateerd

- [tree-browser](/nl/api/css/tree-browser.md) — Both present nested, selectable entries.
- [simple-select](/nl/api/css/simple-select.md) — A select's dropdown reuses this menu surface.
