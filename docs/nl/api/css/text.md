...
| --- | --- |
| `.-color-ai` | <span class="instui-pill -color-danger pantoken-doc-tag">Verouderd</span> — use `.-color-ai-highlight`. |
...
- [heading](/nl/api/css/heading.md) — Typography for headings rather than body text.
- [truncate](/nl/api/css/truncate.md) — Clips this text to one line or a set number of lines.
