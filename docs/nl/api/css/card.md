...
- [heading](/nl/api/css/heading.md) — Place directly in the card or inside a container section.
- [button](/nl/api/css/button.md) — Place directly in the card or inside a container section.
- [img](/nl/api/css/img.md) — Place directly in the card as a media region.
- [badge](/nl/api/css/badge.md) — Place directly in the card as a status indicator.
