...
- [alert](/nl/api/css/alert.md) — A non-dismissible, status-coloured counterpart for inline messages.
- [close-button](/nl/api/css/close-button.md) — The dismiss control a banner may include.
