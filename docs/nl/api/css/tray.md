...
| `.-size-regular` | <span class="instui-pill -color-danger pantoken-doc-tag">Verouderd</span> — use `.-size-md`. |
| `.-size-sm` | Small. |
...
- [modal](/nl/api/css/modal.md) — The same dismissible overlay pattern, centred instead of edge-pinned.
- [popover](/nl/api/css/popover.md) — The generic top-layer surface this builds on.
