...
- [modal.body](/api/css/modal.body.md)
- [modal.footer](/api/css/modal.footer.md)
- [modal.header](/api/css/modal.header.md)

## Related

- [tray](/api/css/tray.md) — A tray is the same dismissible overlay pattern, anchored to a screen edge.
