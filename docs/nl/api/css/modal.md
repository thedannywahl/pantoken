...
- [modal.body](/nl/api/css/modal.body.md)
- [modal.footer](/nl/api/css/modal.footer.md)
- [modal.header](/nl/api/css/modal.header.md)

## Gerelateerd

- [tray](/nl/api/css/tray.md) — A tray is the same dismissible overlay pattern, anchored to a screen edge.
