...
| `.-color-primary-inverse` | <span class="instui-pill -color-danger pantoken-doc-tag">Verouderd</span> — use `.-on-color`. |
...
- [close-button](/nl/api/css/close-button.md) — The icon-only dismiss button.
