...
- [modal.body](/es/api/css/modal.body.md)
- [modal.footer](/es/api/css/modal.footer.md)
- [modal.header](/es/api/css/modal.header.md)

## Relacionado

- [tray](/es/api/css/tray.md) — A tray is the same dismissible overlay pattern, anchored to a screen edge.
