...
- [heading](/es/api/css/heading.md) — Typography for headings rather than body text.
- [truncate](/es/api/css/truncate.md) — Clips this text to one line or a set number of lines.
