...
- [menu.group](/es/api/css/menu.group.md)
- [menu.item](/es/api/css/menu.item.md)
- [menu.separator](/es/api/css/menu.separator.md)
- [side-nav-bar.item](/es/api/css/side-nav-bar.item.md)

## Relacionado

- [tree-browser](/es/api/css/tree-browser.md) — Both present nested, selectable entries.
- [simple-select](/es/api/css/simple-select.md) — A select's dropdown reuses this menu surface.
