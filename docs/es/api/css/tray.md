...
| `.-size-regular` | <span class="instui-pill -color-danger pantoken-doc-tag">Obsoleto</span> — use `.-size-md`. |
| `.-size-sm` | Small. |
...
- [modal](/es/api/css/modal.md) — The same dismissible overlay pattern, centred instead of edge-pinned.
- [popover](/es/api/css/popover.md) — The generic top-layer surface this builds on.
