...
- [text-area](/es/api/css/text-area.md) — The multi-line counterpart with the same states and sizes.
- [number-input](/es/api/css/number-input.md) — The numeric-entry input sharing this chrome.
- [simple-select](/es/api/css/simple-select.md) — The native select sharing this field chrome.
- [input-group](/es/api/css/input-group.md) — Wraps this input with leading and trailing slots.
