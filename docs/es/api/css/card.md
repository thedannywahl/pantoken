...
- [heading](/es/api/css/heading.md) — Place directly in the card or inside a container section.
- [button](/es/api/css/button.md) — Place directly in the card or inside a container section.
- [img](/es/api/css/img.md) — Place directly in the card as a media region.
- [badge](/es/api/css/badge.md) — Place directly in the card as a status indicator.
