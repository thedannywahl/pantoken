...
# Funktion: runTokenPlugins()

> **runTokenPlugins**(`tokens`, `theme`, `plugins`): [`Token`](../interfaces/Token.md)[]

<span class="instui-pill -color-warning pantoken-doc-tag">Beta</span>

Kør hvert plugins `tokens` krog i rækkefølge. Hver krog modtager den aktuelle liste og returnerer den
fulde erstatning; resultatet dedupliseres efter navn.
