...
<!-- js-requirement -->
> [!TIP]
> **JS-forbedring** — Denne components CSS gengives og virker af sig selv; parr den med `@pantoken/interactions` for at tilføje den interaktive adfærd. Dens `-should-animate` modifikator er drevet af denne adfærd. Se [modifikatortabellen nedenfor](#modifiers).
