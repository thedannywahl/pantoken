...
`.instui-metric` — En mærket statistik — en stor værdi over en billedtekst.

Indstiller sin egen `gap` mellem værdien og etiketten, og sin egen horisontale `padding`; kæding af en `-gap-*`/`-p-*`/`-padding-*` mellemrums-utility-modifikator tilsidesætter disse indbyggede værdier.

**Kilde:** [metric.css](https://github.com/thedannywahl/pantoken/blob/main/formats/components/src/components/metric/metric.css)
...
| --------------------- | --------------------------------- |
| `.-text-align-center` | Centrer værdien og etiketten.     |
| `.-text-align-end`    | Slutjustér værdien og etiketten.  |
| `.-text-align-start`  | Startjustér værdien og etiketten. |

## Parts

| Part     | Description                  |
| -------- | ---------------------------- |
| `.label` | Billedteksten under værdien. |
| `.value` | Det store metrik-tal.        |
