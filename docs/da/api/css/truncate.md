...
<!-- js-requirement -->
> [!TIP]
> **JS-krav** — Denne komponent har ingen egen CSS — dens markup og adfærd kommer helt fra `@pantoken/interactions`. Dens `--max-lines-auto`-modifikator styres af denne adfærd. Se [modifikatortabellen nedenfor](#modifiers).
