...
# Funktion: defaultThemeCssAssets()

> **defaultThemeCssAssets**(`theme?`, `mode?`): [`CdnFile`](../interfaces/CdnFile.md)[]

<span class="instui-pill -color-warning pantoken-doc-tag">Alpha</span>

Komponent-stilarkene til et givet tema/tilstands par (token-ark plus det konstante sæt).

## Parametre

### theme?

[`ThemeVariant`](../type-aliases/ThemeVariant.md) = `"rebrand"`
