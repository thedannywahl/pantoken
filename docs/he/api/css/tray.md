...
| `.-size-regular` | <span class="instui-pill -color-danger pantoken-doc-tag">מופרט</span> — use `.-size-md`. |
| `.-size-sm` | Small. |
...
- [modal](/he/api/css/modal.md) — The same dismissible overlay pattern, centred instead of edge-pinned.
- [popover](/he/api/css/popover.md) — The generic top-layer surface this builds on.
