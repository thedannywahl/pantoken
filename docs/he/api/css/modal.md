...
- [modal.body](/he/api/css/modal.body.md)
- [modal.footer](/he/api/css/modal.footer.md)
- [modal.header](/he/api/css/modal.header.md)

## קשור

- [tray](/he/api/css/tray.md) — A tray is the same dismissible overlay pattern, anchored to a screen edge.
