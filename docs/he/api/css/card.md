...
- [heading](/he/api/css/heading.md) — Place directly in the card or inside a container section.
- [button](/he/api/css/button.md) — Place directly in the card or inside a container section.
- [img](/he/api/css/img.md) — Place directly in the card as a media region.
- [badge](/he/api/css/badge.md) — Place directly in the card as a status indicator.
