...
| מחליף | תיאור |
| --- | --- |
| `.-color-ai` | <span class="instui-pill -color-danger pantoken-doc-tag">מופרט</span> — use `.-color-ai-highlight`. |
...
- [heading](/he/api/css/heading.md) — Typography for headings rather than body text.
- [truncate](/he/api/css/truncate.md) — Clips this text to one line or a set number of lines.
