...
- [text-area](/he/api/css/text-area.md) — The multi-line counterpart with the same states and sizes.
- [number-input](/he/api/css/number-input.md) — The numeric-entry input sharing this chrome.
- [simple-select](/he/api/css/simple-select.md) — The native select sharing this field chrome.
- [input-group](/he/api/css/input-group.md) — Wraps this input with leading and trailing slots.
