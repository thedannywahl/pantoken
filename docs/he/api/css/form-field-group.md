...
- [form-field](/he/api/css/form-field.md)
- [form-field-messages](/he/api/css/form-field-messages.md)

## קשור

- [form-field](/he/api/css/form-field.md) — The single field this group repeats.
- [radio-input-group](/he/api/css/radio-input-group.md) — Groups radio inputs under a legend.
