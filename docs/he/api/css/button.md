...
| `.-color-primary-inverse` | <span class="instui-pill -color-danger pantoken-doc-tag">מופרט</span> — use `.-on-color`. |
...
- [close-button](/he/api/css/close-button.md) — The icon-only dismiss button.
