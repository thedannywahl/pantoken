...
- [text-input](/en-AU/api/css/text-input.md) — Shares the same field chrome, states, and sizes.
- [menu](/en-AU/api/css/menu.md) — The dropdown surface a richer select reuses.
