...
- [modal](/en-AU/api/css/modal.md) — The same dismissible overlay pattern, centred instead of edge-pinned.
- [popover](/en-AU/api/css/popover.md) — The generic top-layer surface this builds on.
