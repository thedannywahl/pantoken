...
- [heading](/en-AU/api/css/heading.md) — Place directly in the card or inside a container section.
- [button](/en-AU/api/css/button.md) — Place directly in the card or inside a container section.
- [img](/en-AU/api/css/img.md) — Place directly in the card as a media region.
- [badge](/en-AU/api/css/badge.md) — Place directly in the card as a status indicator.
