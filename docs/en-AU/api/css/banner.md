...
- [alert](/en-AU/api/css/alert.md) — A non-dismissible, status-coloured counterpart for inline messages.
- [close-button](/en-AU/api/css/close-button.md) — The dismiss control a banner may include.
