...
- [modal.body](/fr/api/css/modal.body.md)
- [modal.footer](/fr/api/css/modal.footer.md)
- [modal.header](/fr/api/css/modal.header.md)

## Liés

- [tray](/fr/api/css/tray.md) — A tray is the same dismissible overlay pattern, anchored to a screen edge.
