...
- [form-field](/fr/api/css/form-field.md)
- [form-field-messages](/fr/api/css/form-field-messages.md)

## Liés

- [form-field](/fr/api/css/form-field.md) — The single field this group repeats.
- [radio-input-group](/fr/api/css/radio-input-group.md) — Groups radio inputs under a legend.
