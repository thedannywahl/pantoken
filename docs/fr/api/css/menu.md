...
- [menu.group](/fr/api/css/menu.group.md)
- [menu.item](/fr/api/css/menu.item.md)
- [menu.separator](/fr/api/css/menu.separator.md)
- [side-nav-bar.item](/fr/api/css/side-nav-bar.item.md)

## Liés

- [tree-browser](/fr/api/css/tree-browser.md) — Both present nested, selectable entries.
- [simple-select](/fr/api/css/simple-select.md) — A select's dropdown reuses this menu surface.
