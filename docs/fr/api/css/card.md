...
- [heading](/fr/api/css/heading.md) — Place directly in the card or inside a container section.
- [button](/fr/api/css/button.md) — Place directly in the card or inside a container section.
- [img](/fr/api/css/img.md) — Place directly in the card as a media region.
- [badge](/fr/api/css/badge.md) — Place directly in the card as a status indicator.
