...
- [modal.body](/pl/api/css/modal.body.md)
- [modal.footer](/pl/api/css/modal.footer.md)
- [modal.header](/pl/api/css/modal.header.md)

## Powiązane

- [tray](/pl/api/css/tray.md) — A tray is the same dismissible overlay pattern, anchored to a screen edge.
