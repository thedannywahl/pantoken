...
| Modyfikator | Opis |
| --- | --- |
| `.-color-ai` | <span class="instui-pill -color-danger pantoken-doc-tag">Przestarzałe</span> — use `.-color-ai-highlight`. |
...
- [heading](/pl/api/css/heading.md) — Typography for headings rather than body text.
- [truncate](/pl/api/css/truncate.md) — Clips this text to one line or a set number of lines.
