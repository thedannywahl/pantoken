...
- [menu.group](/pl/api/css/menu.group.md)
- [menu.item](/pl/api/css/menu.item.md)
- [menu.separator](/pl/api/css/menu.separator.md)
- [side-nav-bar.item](/pl/api/css/side-nav-bar.item.md)

## Powiązane

- [tree-browser](/pl/api/css/tree-browser.md) — Both present nested, selectable entries.
- [simple-select](/pl/api/css/simple-select.md) — A select's dropdown reuses this menu surface.
