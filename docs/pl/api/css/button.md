...
| `.-color-primary-inverse` | <span class="instui-pill -color-danger pantoken-doc-tag">Przestarzałe</span> — use `.-on-color`. |
...
- [close-button](/pl/api/css/close-button.md) — The icon-only dismiss button.
