...
- [heading](/pl/api/css/heading.md) — Place directly in the card or inside a container section.
- [button](/pl/api/css/button.md) — Place directly in the card or inside a container section.
- [img](/pl/api/css/img.md) — Place directly in the card as a media region.
- [badge](/pl/api/css/badge.md) — Place directly in the card as a status indicator.
