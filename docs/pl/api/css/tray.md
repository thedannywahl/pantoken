...
| `.-size-regular` | <span class="instui-pill -color-danger pantoken-doc-tag">Przestarzałe</span> — use `.-size-md`. |
| `.-size-sm` | Small. |
...
- [modal](/pl/api/css/modal.md) — The same dismissible overlay pattern, centred instead of edge-pinned.
- [popover](/pl/api/css/popover.md) — The generic top-layer surface this builds on.
