...
features:
  ...
  - icon:
    ...
    title: Sèvi ak pi piti pakè a
    details: Enstale sèlman @pantoken/css pou yon fichye stil, @pantoken/react pou hooks ak ikon, oswa yon preset bundler pou Tailwind, Panda, oswa MUI.
  - icon:
