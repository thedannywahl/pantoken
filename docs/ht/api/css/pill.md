...
| `.-render-icon-<name>` | <span class="instui-pill -color-danger pantoken-doc-tag">Depreke</span> — The former `renderIcon` prop; still works as an alias, but use `-icon-<name>` instead. |
...
- [badge](/ht/api/css/badge.md) — A badge is the count or notification counterpart.
- [tag](/ht/api/css/tag.md) — A tag is the removable, form-oriented counterpart.
