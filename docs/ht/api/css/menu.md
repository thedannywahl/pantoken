...
- [menu.group](/ht/api/css/menu.group.md)
- [menu.item](/ht/api/css/menu.item.md)
- [menu.separator](/ht/api/css/menu.separator.md)
- [side-nav-bar.item](/ht/api/css/side-nav-bar.item.md)

## Ki gen rapò

- [tree-browser](/ht/api/css/tree-browser.md) — Both present nested, selectable entries.
- [simple-select](/ht/api/css/simple-select.md) — A select's dropdown reuses this menu surface.
