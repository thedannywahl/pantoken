...
- [checkbox](/ht/api/css/checkbox.md) — The multi-select counterpart to a single-select radio.
- [radio-input-group](/ht/api/css/radio-input-group.md) — Collects radios into one single-select fieldset.
