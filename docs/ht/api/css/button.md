...
| `.-color-primary-inverse` | <span class="instui-pill -color-danger pantoken-doc-tag">Depreke</span> — use `.-on-color`. |
...
- [close-button](/ht/api/css/close-button.md) — The icon-only dismiss button.
