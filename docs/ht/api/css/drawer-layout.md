...
- [drawer-layout.content](/ht/api/css/drawer-layout.content.md)
- [drawer-layout.tray](/ht/api/css/drawer-layout.tray.md)
- [tray](/ht/api/css/tray.md)

## Ki gen rapò

- [tray](/ht/api/css/tray.md) — A standalone edge overlay; this layout keeps tray and content in the same flow.
- [context-view](/ht/api/css/context-view.md) — A smaller anchored surface for contextual actions and detail.
