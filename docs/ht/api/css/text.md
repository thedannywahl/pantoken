...
| --- | --- |
| `.-color-ai` | <span class="instui-pill -color-danger pantoken-doc-tag">Depreke</span> — use `.-color-ai-highlight`. |
...
- [heading](/ht/api/css/heading.md) — Typography for headings rather than body text.
- [truncate](/ht/api/css/truncate.md) — Clips this text to one line or a set number of lines.
