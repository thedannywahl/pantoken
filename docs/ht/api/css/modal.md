...
- [modal.body](/ht/api/css/modal.body.md)
- [modal.footer](/ht/api/css/modal.footer.md)
- [modal.header](/ht/api/css/modal.header.md)

## Ki gen rapò

- [tray](/ht/api/css/tray.md) — A tray is the same dismissible overlay pattern, anchored to a screen edge.
