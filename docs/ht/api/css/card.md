...
- [heading](/ht/api/css/heading.md) — Place directly in the card or inside a container section.
- [button](/ht/api/css/button.md) — Place directly in the card or inside a container section.
- [img](/ht/api/css/img.md) — Place directly in the card as a media region.
- [badge](/ht/api/css/badge.md) — Place directly in the card as a status indicator.
