...
| `.-size-regular` | <span class="instui-pill -color-danger pantoken-doc-tag">Depreke</span> — use `.-size-md`. |
| `.-size-sm` | Small. |
...
- [modal](/ht/api/css/modal.md) — The same dismissible overlay pattern, centred instead of edge-pinned.
- [popover](/ht/api/css/popover.md) — The generic top-layer surface this builds on.
