...
- [checkbox](/zh-Hant/api/css/checkbox.md) — The multi-select counterpart to a single-select radio.
- [radio-input-group](/zh-Hant/api/css/radio-input-group.md) — Collects radios into one single-select fieldset.
