...
| `.-size-regular` | <span class="instui-pill -color-danger pantoken-doc-tag">已棄用</span> — use `.-size-md`. |
| `.-size-sm` | Small. |
...
- [modal](/zh-Hant/api/css/modal.md) — The same dismissible overlay pattern, centred instead of edge-pinned.
- [popover](/zh-Hant/api/css/popover.md) — The generic top-layer surface this builds on.
