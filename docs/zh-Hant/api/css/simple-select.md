...
- [text-input](/zh-Hant/api/css/text-input.md) — Shares the same field chrome, states, and sizes.
- [menu](/zh-Hant/api/css/menu.md) — The dropdown surface a richer select reuses.
