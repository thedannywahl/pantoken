...
- [modal.body](/zh-Hant/api/css/modal.body.md)
- [modal.footer](/zh-Hant/api/css/modal.footer.md)
- [modal.header](/zh-Hant/api/css/modal.header.md)

## 相關

- [tray](/zh-Hant/api/css/tray.md) — A tray is the same dismissible overlay pattern, anchored to a screen edge.
