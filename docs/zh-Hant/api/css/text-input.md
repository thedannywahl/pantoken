...
- [text-area](/zh-Hant/api/css/text-area.md) — The multi-line counterpart with the same states and sizes.
- [number-input](/zh-Hant/api/css/number-input.md) — The numeric-entry input sharing this chrome.
- [simple-select](/zh-Hant/api/css/simple-select.md) — The native select sharing this field chrome.
- [input-group](/zh-Hant/api/css/input-group.md) — Wraps this input with leading and trailing slots.
