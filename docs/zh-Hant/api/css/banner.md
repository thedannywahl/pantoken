...
- [alert](/zh-Hant/api/css/alert.md) — A non-dismissible, status-coloured counterpart for inline messages.
- [close-button](/zh-Hant/api/css/close-button.md) — The dismiss control a banner may include.
