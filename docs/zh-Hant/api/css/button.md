...
| `.-color-primary-inverse` | <span class="instui-pill -color-danger pantoken-doc-tag">已棄用</span> — use `.-on-color`. |
...
- [close-button](/zh-Hant/api/css/close-button.md) — The icon-only dismiss button.
