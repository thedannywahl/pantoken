...
| `.-render-icon-<name>` | <span class="instui-pill -color-danger pantoken-doc-tag">已棄用</span> — The former `renderIcon` prop; still works as an alias, but use `-icon-<name>` instead. |
...
- [badge](/zh-Hant/api/css/badge.md) — A badge is the count or notification counterpart.
- [tag](/zh-Hant/api/css/tag.md) — A tag is the removable, form-oriented counterpart.
