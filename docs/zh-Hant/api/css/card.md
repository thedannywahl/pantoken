...
- [heading](/zh-Hant/api/css/heading.md) — Place directly in the card or inside a container section.
- [button](/zh-Hant/api/css/button.md) — Place directly in the card or inside a container section.
- [img](/zh-Hant/api/css/img.md) — Place directly in the card as a media region.
- [badge](/zh-Hant/api/css/badge.md) — Place directly in the card as a status indicator.
