...
| 修飾器 | 說明 |
| --- | --- |
| `.-color-ai` | <span class="instui-pill -color-danger pantoken-doc-tag">已棄用</span> — use `.-color-ai-highlight`. |
...
- [heading](/zh-Hant/api/css/heading.md) — Typography for headings rather than body text.
- [truncate](/zh-Hant/api/css/truncate.md) — Clips this text to one line or a set number of lines.
