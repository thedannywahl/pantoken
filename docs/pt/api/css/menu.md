...
- [menu.group](/pt/api/css/menu.group.md)
- [menu.item](/pt/api/css/menu.item.md)
- [menu.separator](/pt/api/css/menu.separator.md)
- [side-nav-bar.item](/pt/api/css/side-nav-bar.item.md)

## Relacionados

- [tree-browser](/pt/api/css/tree-browser.md) — Both present nested, selectable entries.
- [simple-select](/pt/api/css/simple-select.md) — A select's dropdown reuses this menu surface.
