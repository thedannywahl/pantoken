...
| `.-color-primary-inverse` | <span class="instui-pill -color-danger pantoken-doc-tag">Obsoleto</span> — use `.-on-color`. |
...
- [close-button](/pt/api/css/close-button.md) — The icon-only dismiss button.
