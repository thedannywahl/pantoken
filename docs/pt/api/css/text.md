...
| --- | --- |
| `.-color-ai` | <span class="instui-pill -color-danger pantoken-doc-tag">Obsoleto</span> — use `.-color-ai-highlight`. |
...
- [heading](/pt/api/css/heading.md) — Typography for headings rather than body text.
- [truncate](/pt/api/css/truncate.md) — Clips this text to one line or a set number of lines.
