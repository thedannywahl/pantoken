...
- [modal.body](/pt/api/css/modal.body.md)
- [modal.footer](/pt/api/css/modal.footer.md)
- [modal.header](/pt/api/css/modal.header.md)

## Relacionados

- [tray](/pt/api/css/tray.md) — A tray is the same dismissible overlay pattern, anchored to a screen edge.
