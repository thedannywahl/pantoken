...
- [table.body](/pt/api/css/table.body.md)
- [table.cell](/pt/api/css/table.cell.md)
- [table.col-header](/pt/api/css/table.col-header.md)
- [table.head](/pt/api/css/table.head.md)
- [table.row](/pt/api/css/table.row.md)
- [table.row-header](/pt/api/css/table.row-header.md)
