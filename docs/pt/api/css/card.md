...
- [heading](/pt/api/css/heading.md) — Place directly in the card or inside a container section.
- [button](/pt/api/css/button.md) — Place directly in the card or inside a container section.
- [img](/pt/api/css/img.md) — Place directly in the card as a media region.
- [badge](/pt/api/css/badge.md) — Place directly in the card as a status indicator.
