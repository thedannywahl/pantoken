...
<!-- js-requirement -->
> [!TIP]
> **Melhoria JS** — This component's CSS renders and works on its own; pair it with `@pantoken/interactions` to add the interactive behavior. See the [modifier table below](#modifiers).
...
- [byline](/pt/api/css/byline.md) — Can host an avatar as its leading hero figure.
