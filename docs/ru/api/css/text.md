...
| --- | --- |
| `.-color-ai` | <span class="instui-pill -color-danger pantoken-doc-tag">Устарело</span> — use `.-color-ai-highlight`. |
...
- [heading](/ru/api/css/heading.md) — Typography for headings rather than body text.
- [truncate](/ru/api/css/truncate.md) — Clips this text to one line or a set number of lines.
