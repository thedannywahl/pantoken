...
| `.-size-regular` | <span class="instui-pill -color-danger pantoken-doc-tag">Устарело</span> — use `.-size-md`. |
| `.-size-sm` | Small. |
...
- [modal](/ru/api/css/modal.md) — The same dismissible overlay pattern, centred instead of edge-pinned.
- [popover](/ru/api/css/popover.md) — The generic top-layer surface this builds on.
