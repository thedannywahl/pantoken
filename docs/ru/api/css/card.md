...
- [heading](/ru/api/css/heading.md) — Place directly in the card or inside a container section.
- [button](/ru/api/css/button.md) — Place directly in the card or inside a container section.
- [img](/ru/api/css/img.md) — Place directly in the card as a media region.
- [badge](/ru/api/css/badge.md) — Place directly in the card as a status indicator.
