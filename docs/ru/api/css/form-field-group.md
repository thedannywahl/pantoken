...
- [form-field](/ru/api/css/form-field.md)
- [form-field-messages](/ru/api/css/form-field-messages.md)

## Связанные

- [form-field](/ru/api/css/form-field.md) — The single field this group repeats.
- [radio-input-group](/ru/api/css/radio-input-group.md) — Groups radio inputs under a legend.
