...
| `.-color-primary-inverse` | <span class="instui-pill -color-danger pantoken-doc-tag">Устарело</span> — use `.-on-color`. |
...
- [close-button](/ru/api/css/close-button.md) — The icon-only dismiss button.
