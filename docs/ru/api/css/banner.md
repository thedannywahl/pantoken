...
- [alert](/ru/api/css/alert.md) — A non-dismissible, status-coloured counterpart for inline messages.
- [close-button](/ru/api/css/close-button.md) — The dismiss control a banner may include.
