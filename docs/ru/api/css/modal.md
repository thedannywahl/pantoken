...
- [modal.body](/ru/api/css/modal.body.md)
- [modal.footer](/ru/api/css/modal.footer.md)
- [modal.header](/ru/api/css/modal.header.md)

## Связанные

- [tray](/ru/api/css/tray.md) — A tray is the same dismissible overlay pattern, anchored to a screen edge.
