...
features:
  ...
  - icon:
    ...
    details: Токены поставляются как vendored статические JSON, поэтому &grave;npm i pantoken&grave; никогда не обращается к GitHub-only источнику. Готовы к публикации, с семантическим версионированием и дружелюбны к оффлайн‑использованию.
---
