...
- [heading](/sv/api/css/heading.md) — Place directly in the card or inside a container section.
- [button](/sv/api/css/button.md) — Place directly in the card or inside a container section.
- [img](/sv/api/css/img.md) — Place directly in the card as a media region.
- [badge](/sv/api/css/badge.md) — Place directly in the card as a status indicator.
