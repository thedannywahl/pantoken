...
| `.-color-primary-inverse` | <span class="instui-pill -color-danger pantoken-doc-tag">Föråldrad</span> — use `.-on-color`. |
...
- [close-button](/sv/api/css/close-button.md) — The icon-only dismiss button.
