...
- [menu.group](/sv/api/css/menu.group.md)
- [menu.item](/sv/api/css/menu.item.md)
- [menu.separator](/sv/api/css/menu.separator.md)
- [side-nav-bar.item](/sv/api/css/side-nav-bar.item.md)

## Relaterat

- [tree-browser](/sv/api/css/tree-browser.md) — Both present nested, selectable entries.
- [simple-select](/sv/api/css/simple-select.md) — A select's dropdown reuses this menu surface.
