...
- [modal.body](/sv/api/css/modal.body.md)
- [modal.footer](/sv/api/css/modal.footer.md)
- [modal.header](/sv/api/css/modal.header.md)

## Relaterat

- [tray](/sv/api/css/tray.md) — A tray is the same dismissible overlay pattern, anchored to a screen edge.
