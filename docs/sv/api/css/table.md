...
- [table.body](/sv/api/css/table.body.md)
- [table.cell](/sv/api/css/table.cell.md)
- [table.col-header](/sv/api/css/table.col-header.md)
- [table.head](/sv/api/css/table.head.md)
- [table.row](/sv/api/css/table.row.md)
- [table.row-header](/sv/api/css/table.row-header.md)
