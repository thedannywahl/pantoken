...
| --- | --- |
| `.-color-ai` | <span class="instui-pill -color-danger pantoken-doc-tag">Föråldrad</span> — use `.-color-ai-highlight`. |
...
- [heading](/sv/api/css/heading.md) — Typography for headings rather than body text.
- [truncate](/sv/api/css/truncate.md) — Clips this text to one line or a set number of lines.
