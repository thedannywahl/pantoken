...
| `.-size-regular` | <span class="instui-pill -color-danger pantoken-doc-tag">Föråldrad</span> — use `.-size-md`. |
| `.-size-sm` | Small. |
...
- [modal](/sv/api/css/modal.md) — The same dismissible overlay pattern, centred instead of edge-pinned.
- [popover](/sv/api/css/popover.md) — The generic top-layer surface this builds on.
