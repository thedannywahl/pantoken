...
| `.-color-primary-inverse` | <span class="instui-pill -color-danger pantoken-doc-tag">Застаріле</span> — use `.-on-color`. |
...
- [close-button](/uk/api/css/close-button.md) — The icon-only dismiss button.
