...
- [modal.body](/uk/api/css/modal.body.md)
- [modal.footer](/uk/api/css/modal.footer.md)
- [modal.header](/uk/api/css/modal.header.md)

## Пов'язані

- [tray](/uk/api/css/tray.md) — A tray is the same dismissible overlay pattern, anchored to a screen edge.
