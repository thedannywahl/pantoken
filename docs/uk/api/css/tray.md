...
| `.-size-regular` | <span class="instui-pill -color-danger pantoken-doc-tag">Застаріле</span> — use `.-size-md`. |
| `.-size-sm` | Small. |
...
- [modal](/uk/api/css/modal.md) — The same dismissible overlay pattern, centred instead of edge-pinned.
- [popover](/uk/api/css/popover.md) — The generic top-layer surface this builds on.
