...
| Модифікатор | Опис |
| --- | --- |
| `.-color-ai` | <span class="instui-pill -color-danger pantoken-doc-tag">Застаріле</span> — use `.-color-ai-highlight`. |
...
- [heading](/uk/api/css/heading.md) — Typography for headings rather than body text.
- [truncate](/uk/api/css/truncate.md) — Clips this text to one line or a set number of lines.
