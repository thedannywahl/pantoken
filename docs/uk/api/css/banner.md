...
- [alert](/uk/api/css/alert.md) — A non-dismissible, status-coloured counterpart for inline messages.
- [close-button](/uk/api/css/close-button.md) — The dismiss control a banner may include.
