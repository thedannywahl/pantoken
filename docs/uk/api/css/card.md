...
- [heading](/uk/api/css/heading.md) — Place directly in the card or inside a container section.
- [button](/uk/api/css/button.md) — Place directly in the card or inside a container section.
- [img](/uk/api/css/img.md) — Place directly in the card as a media region.
- [badge](/uk/api/css/badge.md) — Place directly in the card as a status indicator.
