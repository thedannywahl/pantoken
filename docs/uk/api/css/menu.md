...
- [menu.group](/uk/api/css/menu.group.md)
- [menu.item](/uk/api/css/menu.item.md)
- [menu.separator](/uk/api/css/menu.separator.md)
- [side-nav-bar.item](/uk/api/css/side-nav-bar.item.md)

## Пов'язані

- [tree-browser](/uk/api/css/tree-browser.md) — Both present nested, selectable entries.
- [simple-select](/uk/api/css/simple-select.md) — A select's dropdown reuses this menu surface.
