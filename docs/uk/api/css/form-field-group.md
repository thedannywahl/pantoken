...
- [form-field](/uk/api/css/form-field.md)
- [form-field-messages](/uk/api/css/form-field-messages.md)

## Пов'язані

- [form-field](/uk/api/css/form-field.md) — The single field this group repeats.
- [radio-input-group](/uk/api/css/radio-input-group.md) — Groups radio inputs under a legend.
