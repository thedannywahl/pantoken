...
- [text-area](/uk/api/css/text-area.md) — The multi-line counterpart with the same states and sizes.
- [number-input](/uk/api/css/number-input.md) — The numeric-entry input sharing this chrome.
- [simple-select](/uk/api/css/simple-select.md) — The native select sharing this field chrome.
- [input-group](/uk/api/css/input-group.md) — Wraps this input with leading and trailing slots.
