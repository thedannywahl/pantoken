...
`.instui-input-group` — տեքստային մուտքի շուրջ ճակատ՝ առաջատար և հետամտական պատկերակի անցքերով:

Շարակցում է նույն դաշտի քրոմ `text-input` պատկերակի անցքերով երկու կողմերում; `-should-not-wrap` անհրաժեշտ է միայն այն ժամանակ, երբ խմբի բովանդակությունը հակառակ դեպքում կան ծայրաքալ երկրորդ տողում:

**Աղբյուր:** [input-group.css](https://github.com/thedannywahl/pantoken/blob/main/formats/components/src/components/input-group/input-group.css)
...
| `.-should-not-wrap` | Պահել խումբը մեկ տողում (ոչ մի փաթաթում): |
...
| Part      | Description                     |
| --------- | ------------------------------- |
| `.after`  | Հետամտական բովանդակության անցք: |
| `.before` | Առաջատար բովանդակության անցք:   |
...
- [text-input](/hy/api/css/text-input.md) — Շարակցում է տեքստային մուտքում՝ ավելացնելով առաջատար և հետամտական պատկերակի անցքեր:
