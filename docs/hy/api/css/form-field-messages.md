...
`.instui-form-field-messages` — Դաշտի օգնություն և վավերացման հաղորդագրություններ — ակնարկ, սխալ, հաջողություն և միայն էկրան-ընթերցողի համար — սխալի և հաջողության վրա գլիֆով:

Սահմանում է իր սեփական `gap` կուտակային հաղորդագրությունների միջև; շղթայակցել `-gap-*` տարածության կոմունալ մոդիֆիկատորը անտեսում է այն ներկառուցված արժեքը:

**Աղբյուր:** [form-field-messages.css](https://github.com/thedannywahl/pantoken/blob/main/formats/components/src/components/form-field-messages/form-field-messages.css)

## Accessibility

`-type-screenreader-only` հաղորդագրությունը տեսողականորեն թաքնված է, բայց մնում է մատչելիության ծառում, ուստի այն դեռ հայտարարվում է; զուգակցել սխալ և հաջողության հաղորդագրությունները դաշտի հետ aria-describedby միջոցով, որպեսզի օգնական տեխնոլոգիան դրանք կարդա վերահսկողության հետ:
...
| Part                         | Description                                                                                                       |
| ---------------------------- | ----------------------------------------------------------------------------------------------------------------- |
| `.instui-form-field-message` | Կանգուն հաղորդագրություն; դրա `-type-*` ընտրում է ակնարկ, սխալ, հաջողություն կամ միայն էկրան-ընթերցողի տարբերակը: |

## Pseudo-elements

| Pseudo-element | Description                                                                                                                                       |
| -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| `::before`     | Տեղադրում է առաջատար վիճակի գլիֆը սխալ և հաջողության հաղորդագրությունների վրա՝ զգուշացման շրջան սխալների համար և ստուգել շրջան հաջողության համար: |
...
- [form-field](/hy/api/css/form-field.md) — Շրջապատում է պիտակ, վերահսկողություն և այս հաղորդագրությունները:
