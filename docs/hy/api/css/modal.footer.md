...
`.footer` — Գործողությունների շարք (InstUI `Modal.Footer`):

Հայր `modal`'s `-density-compact` և `-color-inverse` փոփոխիչներ վերականգնում են այս անդամին — տե՛ս `modal`'s սեփական doc այդ փոփոխիչների համար:
