...
`.instui-billboard` — Մեծ դատարկ վիճակ կամ գործողության կոչ բլոկ. հերոս պատկեր կամ պատկեր, վերնագիր և հաղորդագրություն:

Այն `.hero`/`.heading`/`.message` մասերը կազմված են սպառողի նշանակումից, ոչ թե վարկածված կառուցվածքից. `-clickable` միայն ավելացնում է վերասլանման ոճավորում, այնպես որ իրական սեղմման թիրախ դեռ պետք է `tabindex` և ստեղնաշար վարչիչ:

**Աղբյուր:** [billboard.css](https://github.com/thedannywahl/pantoken/blob/main/formats/components/src/components/billboard/billboard.css)
...
| --------------- | -------------------------------------------------------------------------------------------- |
| `.-clickable`   | Ինտերակտիվ (սեղմել հնարավոր) ոճավորում վերասլանման հետադարձ կապով:                           |
| `.-icon-*`      | Գծել առաջատար պատկերային գլիֆ `.hero` (օր. `<span class="hero -icon-inbox"></span>`):        |
| `.-size-large`  | -size-lg-ի երկար ձևի ծածկանուն:                                                              |
| `.-size-lg`     | Մեծ. ավելի լայն հեռավորություն ավելի մեծ վերնագրով, հաղորդագրությամբ և հերոս պատկերով:       |
| `.-size-md`     | Միջին (լռակյալ). ստանդարտ հեռավորություն միջին վերնագրով, հաղորդագրությամբ և հերոս պատկերով: |
| `.-size-medium` | -size-md-ի երկար ձևի ծածկանուն:                                                              |
| `.-size-sm`     | Փոքր. ավելի տեղավար հեռավորություն ավելի փոքր վերնագրով, հաղորդագրությամբ և հերոս պատկերով:  |
| `.-size-small`  | -size-sm-ի երկար ձևի ծածկանուն:                                                              |

## Parts

| Part       | Description                            |
| ---------- | -------------------------------------- |
| `.heading` | Գովազդային պաստառի վերնագիր:           |
| `.hero`    | Ընտրական առաջատար պատկերակ կամ պատկեր: |
| `.message` | Աջակցական հաղորդագրություն:            |
