...
`.instui-menu` — Տարրերի, խմբերի և բաժանարարների ընկնող մակերես:

Կազմել գրառումները որպես `.item` (տե՛ս `menu.item` անդամ), պիտակել բաժինը `.group` (տե՛ս `menu.group`), և բաժանել բաժինները `.separator` (տե՛ս `menu.separator`):

**Աղբյուր:** [group.css](https://github.com/thedannywahl/pantoken/blob/main/formats/components/src/components/menu/members/group/group.css)
...
- [menu.group](/hy/api/css/menu.group.md)
- [menu.item](/hy/api/css/menu.item.md)
- [menu.separator](/hy/api/css/menu.separator.md)
- [side-nav-bar.item](/hy/api/css/side-nav-bar.item.md)

## Ավելին կապված

- [tree-browser](/hy/api/css/tree-browser.md) — Երկուսն էլ ներկայացնում են ներդրված, ընտրելի գրառումներ:
- [simple-select](/hy/api/css/simple-select.md) — Ընտրության ընկնող ընտրացանկը վերաօգտագործում է այս ընտրացանկի մակերես:
