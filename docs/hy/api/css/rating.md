...
`.instui-rating` — Աստղի գնահատական լցված և դատարկ նշանների հետ և ընտրովի թվային պիտակ:

Սահմանում է իր սեփական `gap` աստղի նշանների միջև; `-gap-*` տարածական օգտակար փոփոխիչ շղթայացնելը գերակերպում է այդ ներկառուցված արժեքը:

**Աղբյուր:** [rating.css](https://github.com/thedannywahl/pantoken/blob/main/formats/components/src/components/rating/rating.css)

## Մուտքականություն

Տալ նրան role="img" և aria-label հայտնական գնահատականը, քանի որ աստղերը պատկերակ նշաններ են:
...
| --- | --- |
| `.-icon-*` | Ցուցադրել աստղի նշաններ պատկերակ դասերով (օրինակ, `-icon-star-solid`): |
