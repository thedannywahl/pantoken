...
`.--text-danger` — Սեմանտիկ գույնի ծառայական միջոցներ՝ `.--bg-&lt;name&gt;`, `.--text-&lt;name&gt;` (կրճատված որպես `.--color-&lt;name&gt;`), և `.--border-&lt;name&gt;` կազմակերպված սեմանտիկ պալետրայի համար: Այս բոլորը նաև ունեն բաղադրիչ-կցված կեղծանուն փոփոխիչ (օր. `-bg-danger` ցանկացած `.instui-&lt;component&gt;`-ի վրա):

**Աղբյուր:** [generate.ts](https://github.com/thedannywahl/pantoken/blob/main/formats/components/scripts/generate.ts)
...
| ---------------- | ---------------------------------------------------------------------------------- |
| `.--text-danger` | Կիրառել սեմանտիկ վտանգի տեքստի գույն:                                              |
| `.--bg-*`        | Ֆոնի գույնի ծառայական միջոցներ սեմանտիկ և բաղադրիչ-հավասարեցված անունների համար:   |
| `.--border-*`    | Եզրի գույնի ծառայական միջոցներ սեմանտիկ և բաղադրիչ-հավասարեցված անունների համար:   |
| `.--color-*`     | `--text-*`-ի կեղծանուն տեքստի գույնի ծառայական միջոցների համար:                    |
| `.--text-*`      | Տեքստի գույնի ծառայական միջոցներ սեմանտիկ և բաղադրիչ-հավասարեցված անունների համար: |
