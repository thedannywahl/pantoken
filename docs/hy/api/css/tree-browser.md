...
`.instui-tree-browser` — Բացահայտման ծառ՝ ներված հավաքածուներից և տերևային տարրերից, պտտվող շևրոններով:

Յուրաքանչյուր հավաքածու բնական `&lt;details&gt;` է; դրանք մեկը մյուսի ներսում տեղադրել՝ ծառ կառուցում, և դիտարկիչը հաղորդակցվում է յուրաքանչյուր ճյուղ բացել և փակել:

**Աղբյուր։** [tree-browser.css](https://github.com/thedannywahl/pantoken/blob/main/formats/components/src/components/tree-browser/tree-browser.css)

## Accessibility

Նշեք արմատը role="tree"-ով և յուրաքանչյուր ներված ցուցակը role="group"-ով:
...
| -------------- | ------------------------------------------------------------------- |
| `.-icon-*`     | Նկարեք թղթապանակ/ֆայլ պատկերակներ ամփոփներում և տերևային տարրերում: |
...
| Part    | Description            |
| ------- | ---------------------- |
| `.item` | Տերևային մուտք ծառում: |

## Pseudo-elements

| Pseudo-element | Description                                                                                                                           |
| -------------- | ------------------------------------------------------------------------------------------------------------------------------------- |
| `::before`     | Նկարում է յուրաքանչյուր հավաքածուի բացահայտման շևրոնը՝ մասկավորված պատկերակ, որը պտտվում է ներքև ցույց տալու համար, երբ ճյուղը բաց է: |
...
- [menu](/hy/api/css/menu.md) — Երկուսն ընկալում են ներդրված, ընտրելի մուտքեր:
