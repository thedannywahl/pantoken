...
`.instui-toggle-group` — Շրջանակավոր բացահայտում, որը կառուցված է `&lt;details&gt;`-ի վրա՝ շևրոն ամփոփ տող և ծալովի բովանդակություն:

Կառուցված `&lt;details&gt;`-ի նույն բնական հիմքի վրա, ինչ toggle-details; տեղադրեք `&lt;summary&gt;`-ը առաջինը, որպեսզի այն դառնա կտտացվող գլխավոր տող, իսկ մնացածը ծալովի բովանդակություն:

**Աղբյուր։** [toggle-group.css](https://github.com/thedannywahl/pantoken/blob/main/formats/components/src/components/toggle-group/toggle-group.css)
...
| -------------- | ----------------------------------------------------------------------------------------------------------------------- |
| `::before`     | Նկարում է ամփոփ տողի բացահայտման շևրոնը՝ մասկավորված պատկերակ, որը պտտվում է ներքև ցույց տալու համար, երբ խումբը բաց է: |
...
- [toggle-details](/hy/api/css/toggle-details.md) — Նույն բացահայտման միայնակ, շրջանակազուրկ ձևը:
