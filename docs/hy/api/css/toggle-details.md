...
`.instui-toggle-details` — Ոճավորված բնական `&lt;details&gt;` բացահայտում պտտվող շեղական ուղղությամբ։

Կառուցված բնական `&lt;details&gt;` տարրի վրա, այնպես որ դիտարկիչը շարժում է բացել և փակել, ինչպես նաև ստեղնաշար աջակցություն; CSS միայն թաքցնում է լռելյայն նշիչ և ապահովում պտտվող շեղական ուղղություն։

**Աղբյուր.** [toggle-details.css](https://github.com/thedannywahl/pantoken/blob/main/formats/components/src/components/toggle-details/toggle-details.css)
...
| --- | --- |
| `.-chevron-end` | Տեղավորել շեղական ուղղությունը ամփոփումից հետո։ |
| `.-size-large` | Մեծ. Երկար-ձեւ այլանունը `-size-lg`: |
| `.-size-lg` | Մեծ: |
| `.-size-sm` | Փոքր: |
| `.-size-small` | Փոքր. Երկար-ձեւ այլանունը `-size-sm`: |
| `.-variant-filled` | Լցված (մակերես) տարբերակ։ |

## Պսևդո-էլեմենտներ

| Պսևդո-էլեմենտ | Նկարագիր |
| --- | --- |
| `::before` | Նկարել ամփոփումի բացահայտման շեղական ուղղությունը, ծածկված գլիֆ, որը պտտվում է ներքևում նշել, երբ բացահայտումը բաց է։ |
...
- [toggle-group](/hy/api/css/toggle-group.md) — Նույն բացահայտման շրջանակավոր, խմբավորված ձևը:
