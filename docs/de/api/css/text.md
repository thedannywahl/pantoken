...
| --- | --- |
| `.-color-ai` | <span class="instui-pill -color-danger pantoken-doc-tag">Veraltet</span> — use `.-color-ai-highlight`. |
...
- [heading](/de/api/css/heading.md) — Typography for headings rather than body text.
- [truncate](/de/api/css/truncate.md) — Clips this text to one line or a set number of lines.
