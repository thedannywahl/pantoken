...
| `.-size-regular` | <span class="instui-pill -color-danger pantoken-doc-tag">Veraltet</span> — use `.-size-md`. |
| `.-size-sm` | Small. |
...
- [modal](/de/api/css/modal.md) — The same dismissible overlay pattern, centred instead of edge-pinned.
- [popover](/de/api/css/popover.md) — The generic top-layer surface this builds on.
