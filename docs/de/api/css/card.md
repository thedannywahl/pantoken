...
- [heading](/de/api/css/heading.md) — Place directly in the card or inside a container section.
- [button](/de/api/css/button.md) — Place directly in the card or inside a container section.
- [img](/de/api/css/img.md) — Place directly in the card as a media region.
- [badge](/de/api/css/badge.md) — Place directly in the card as a status indicator.
