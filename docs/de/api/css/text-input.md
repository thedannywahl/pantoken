...
- [text-area](/de/api/css/text-area.md) — The multi-line counterpart with the same states and sizes.
- [number-input](/de/api/css/number-input.md) — The numeric-entry input sharing this chrome.
- [simple-select](/de/api/css/simple-select.md) — The native select sharing this field chrome.
- [input-group](/de/api/css/input-group.md) — Wraps this input with leading and trailing slots.
