...
- [drawer-layout.tray](/de/api/css/drawer-layout.tray.md)
- [tray](/de/api/css/tray.md)

## Verwandt

- [tray](/de/api/css/tray.md) — A standalone edge overlay; this layout keeps tray and content in the same flow.
- [context-view](/de/api/css/context-view.md) — A smaller anchored surface for contextual actions and detail.
