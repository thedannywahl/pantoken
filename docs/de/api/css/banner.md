...
- [alert](/de/api/css/alert.md) — A non-dismissible, status-coloured counterpart for inline messages.
- [close-button](/de/api/css/close-button.md) — The dismiss control a banner may include.
