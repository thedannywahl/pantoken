...
| `.-color-primary-inverse` | <span class="instui-pill -color-danger pantoken-doc-tag">Veraltet</span> — use `.-on-color`. |
...
- [close-button](/de/api/css/close-button.md) — The icon-only dismiss button.
