...
- [menu.group](/de/api/css/menu.group.md)
- [menu.item](/de/api/css/menu.item.md)
- [menu.separator](/de/api/css/menu.separator.md)
- [side-nav-bar.item](/de/api/css/side-nav-bar.item.md)

## Verwandt

- [tree-browser](/de/api/css/tree-browser.md) — Both present nested, selectable entries.
- [simple-select](/de/api/css/simple-select.md) — A select's dropdown reuses this menu surface.
