...
- [modal.body](/de/api/css/modal.body.md)
- [modal.footer](/de/api/css/modal.footer.md)
- [modal.header](/de/api/css/modal.header.md)

## Verwandt

- [tray](/de/api/css/tray.md) — A tray is the same dismissible overlay pattern, anchored to a screen edge.
