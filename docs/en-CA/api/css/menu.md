...
- [menu.group](/en-CA/api/css/menu.group.md)
- [menu.item](/en-CA/api/css/menu.item.md)
- [menu.separator](/en-CA/api/css/menu.separator.md)
- [side-nav-bar.item](/en-CA/api/css/side-nav-bar.item.md)

## Related

- [tree-browser](/en-CA/api/css/tree-browser.md) — Both present nested, selectable entries.
- [simple-select](/en-CA/api/css/simple-select.md) — A select's dropdown reuses this menu surface.
