...
- [text-input](/en-CA/api/css/text-input.md) — Shares the same field chrome, states, and sizes.
- [menu](/en-CA/api/css/menu.md) — The dropdown surface a richer select reuses.
