...
- [modal.body](/en-CA/api/css/modal.body.md)
- [modal.footer](/en-CA/api/css/modal.footer.md)
- [modal.header](/en-CA/api/css/modal.header.md)

## Related

- [tray](/en-CA/api/css/tray.md) — A tray is the same dismissible overlay pattern, anchored to a screen edge.
