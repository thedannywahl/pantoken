...
- [text](/en-CA/api/css/text.md)

## Related

- [tooltip](/en-CA/api/css/tooltip.md) — A tooltip is a smaller, hover- or focus-triggered anchored surface.
- [context-view](/en-CA/api/css/context-view.md) — Context view is a related anchored surface with a pointer.
