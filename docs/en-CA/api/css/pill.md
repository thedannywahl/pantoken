...
- [badge](/en-CA/api/css/badge.md) — A badge is the count or notification counterpart.
- [tag](/en-CA/api/css/tag.md) — A tag is the removable, form-oriented counterpart.
