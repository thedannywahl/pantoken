...
- [heading](/en-CA/api/css/heading.md) — Place directly in the card or inside a container section.
- [button](/en-CA/api/css/button.md) — Place directly in the card or inside a container section.
- [img](/en-CA/api/css/img.md) — Place directly in the card as a media region.
- [badge](/en-CA/api/css/badge.md) — Place directly in the card as a status indicator.
