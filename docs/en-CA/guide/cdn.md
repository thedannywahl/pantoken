...
- **Components tab** — choose individual component stylesheets or the whole `components.css` barrel. Add the base reset or spacing/colour utilities if you need them.
