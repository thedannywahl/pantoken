...
| --- | --- |
| `.-color-ai` | <span class="instui-pill -color-danger pantoken-doc-tag">Kullanımdan kaldırıldı</span> — use `.-color-ai-highlight`. |
...
- [heading](/tr/api/css/heading.md) — Typography for headings rather than body text.
- [truncate](/tr/api/css/truncate.md) — Clips this text to one line or a set number of lines.
