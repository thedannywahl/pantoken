...
- [menu.group](/tr/api/css/menu.group.md)
- [menu.item](/tr/api/css/menu.item.md)
- [menu.separator](/tr/api/css/menu.separator.md)
- [side-nav-bar.item](/tr/api/css/side-nav-bar.item.md)

## İlgili

- [tree-browser](/tr/api/css/tree-browser.md) — Both present nested, selectable entries.
- [simple-select](/tr/api/css/simple-select.md) — A select's dropdown reuses this menu surface.
