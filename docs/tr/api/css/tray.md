...
| `.-size-regular` | <span class="instui-pill -color-danger pantoken-doc-tag">Kullanımdan kaldırıldı</span> — use `.-size-md`. |
| `.-size-sm` | Small. |
...
- [modal](/tr/api/css/modal.md) — The same dismissible overlay pattern, centred instead of edge-pinned.
- [popover](/tr/api/css/popover.md) — The generic top-layer surface this builds on.
