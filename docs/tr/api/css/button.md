...
| `.-color-primary-inverse` | <span class="instui-pill -color-danger pantoken-doc-tag">Kullanımdan kaldırıldı</span> — use `.-on-color`. |
...
- [close-button](/tr/api/css/close-button.md) — The icon-only dismiss button.
