...
- [heading](/tr/api/css/heading.md) — Place directly in the card or inside a container section.
- [button](/tr/api/css/button.md) — Place directly in the card or inside a container section.
- [img](/tr/api/css/img.md) — Place directly in the card as a media region.
- [badge](/tr/api/css/badge.md) — Place directly in the card as a status indicator.
