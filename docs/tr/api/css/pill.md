...
| `.-render-icon-<name>` | <span class="instui-pill -color-danger pantoken-doc-tag">Kullanımdan kaldırıldı</span> — The former `renderIcon` prop; still works as an alias, but use `-icon-<name>` instead. |
...
- [badge](/tr/api/css/badge.md) — A badge is the count or notification counterpart.
- [tag](/tr/api/css/tag.md) — A tag is the removable, form-oriented counterpart.
