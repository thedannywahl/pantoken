...
- [modal.body](/tr/api/css/modal.body.md)
- [modal.footer](/tr/api/css/modal.footer.md)
- [modal.header](/tr/api/css/modal.header.md)

## İlgili

- [tray](/tr/api/css/tray.md) — A tray is the same dismissible overlay pattern, anchored to a screen edge.
