...
- [agent-shell](/tr/api/css/agent-shell.md)
- [breadcrumb](/tr/api/css/breadcrumb.md)
- [button](/tr/api/css/button.md)
- [card](/tr/api/css/card.md)
- [drawer-layout.content](/tr/api/css/drawer-layout.content.md)
- [list](/tr/api/css/list.md)
- [modal.header](/tr/api/css/modal.header.md)
- [side-nav-bar](/tr/api/css/side-nav-bar.md)
- [tabs](/tr/api/css/tabs.md)
- [tabs.panel](/tr/api/css/tabs.panel.md)
