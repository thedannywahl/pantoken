...
# Fonksiyon: pantokenContentCssUrls()

> **pantokenContentCssUrls**(`assets`, `provider?`): `string`[]

Resolves a set of [CdnFile](../../../../platforms/canvas-theme-editor/src/interfaces/CdnFile.md)s to URLs suitable for TinyMCE's `content_css` init option.
