...
`.--text-danger` — أدوات اللون الدلالي: `.--bg-&lt;name&gt;`، `.--text-&lt;name&gt;` (باسم مستعار `.--color-&lt;name&gt;`)، و`.--border-&lt;name&gt;` لوحة اللون الدلالي المختارة. كل واحد من هذه لديه أيضاً معدّل اسم مستعار مرفق مكون (على سبيل المثال `-bg-danger` على أي `.instui-&lt;component&gt;`).
...
| ---------------- | ------------------------------------------------------- |
| `.--text-danger` | تطبيق لون النص الخطر الدلالي.                           |
| `.--bg-*`        | أدوات لون الخلفية للأسماء الدلالية والمحاذاة مع المكون. |
| `.--border-*`    | أدوات لون الحدود للأسماء الدلالية والمحاذاة مع المكون.  |
| `.--color-*`     | اسم مستعار `--text-*` لأدوات لون النص.                  |
| `.--text-*`      | أدوات لون النص للأسماء الدلالية والمحاذاة مع المكون.    |
