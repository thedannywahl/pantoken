...
`.--text-danger` — أدوات ألوان دلالية: `.--bg-&lt;name&gt;`, `.--text-&lt;name&gt;` (معادلة باسم `.--color-&lt;name&gt;`), و`.--border-&lt;name&gt;` لبرنامج الألوان الدلالي المنسق. لكلٍّ منها أيضًا مُعدِّل اسم مستعار مرفق بالمكوّن (على سبيل المثال `-bg-danger` على أي `.instui-&lt;component&gt;`).

**المصدر:** [generate.ts](https://github.com/thedannywahl/pantoken/blob/main/formats/components/scripts/generate.ts)
...
| معدّل | الوصف |
| --- | --- |
| `.--text-danger` | يطبّق لون نص 'الخطر' الدلالي. |
| `.--bg-*` | أدوات ألوان الخلفية للأسماء الدلالية والمتوافقة مع المكوّن. |
| `.--border-*` | أدوات ألوان الحدود للأسماء الدلالية والمتوافقة مع المكوّن. |
| `.--color-*` | اسم مستعار لـ `--text-*` لأدوات لون النص. |
| `.--text-*` | أدوات لون النص للأسماء الدلالية والمتوافقة مع المكوّن. |
