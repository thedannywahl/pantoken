...
`*` — إعادة تعيين عامة اختيارية: `box-sizing`، سطح الصفحة، لون النص الأساسي والخط، `color-scheme`، وقيم الارتباط الافتراضية.
...
| -------------- | -------------------------------------------------------------------------------------- |
| `::after`      | مضمنة في إعادة تعيين عامة `box-sizing: border-box` بحيث تتوقع أحجام الصناديق المُنشأة. |
| `::before`     | مضمنة في إعادة تعيين عامة `box-sizing: border-box` بحيث تتوقع أحجام الصناديق المُنشأة. |
| `::selection`  | تلون النص المظلل بلون ملاح أساسي شفاف.                                                 |
