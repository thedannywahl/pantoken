...
`.instui-text-area` — عنصر `&lt;textarea&gt;` أصلي منسق وقابل لتغيير الحجم مع نفس الحالات والأحجام كإدخال النص.

يشارك حدوده وخلفيته وحالات التركيز مع `text-input` و `simple-select`؛ فقط `resize: vertical` والارتفاع الأدنى الأطول فريدة له.
...
- [text-input](/ar/api/css/text-input.md) — المكافئ أحادي الخط مع نفس الحالات والأحجام.
