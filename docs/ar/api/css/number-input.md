...
`.instui-number-input` — واجهة إدخال رقم مع عمود spinner +/-.

أزرار `.arrows` هي `aria-hidden` وتقديمية بحتة — زيادة/تقليل القيمة عند النقر هي JavaScript الخاصة بالمستهلك لربطها.
...
ضع الاسم القابل للوصول على `&lt;input&gt;` (على سبيل المثال `aria-label`) بحيث يمتلك الحقل القيمة؛ أزرار spinner +/- ديكوريّة وموسومة `aria-hidden="true"`.
...
| Part      | Description                          |
| --------- | ------------------------------------ |
| `.arrows` | عمود spinner +/- في النهاية المضمنة. |
| `.down`   | زر التناقص؛ الزر بدون فئة يزيد.      |

## Pseudo-elements

| Pseudo-element  | Description                                                             |
| --------------- | ----------------------------------------------------------------------- |
| `::before`      | رمز chevron المقنع على كل زر spinner: لأعلى للزيادة، لأسفل على `.down`. |
...
- [text-input](/ar/api/css/text-input.md) — يشارك نفس واجهة إدخال chrome.
- [range-input](/ar/api/css/range-input.md) — عنصر تحكم إدخال رقمي آخر.
