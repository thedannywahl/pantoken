...
| `.-size-large` | كبير. اسم بديل مطوَّل لـ `-size-lg`. |
| `.-size-lg` | كبير. |
| `.-size-md` | (الافتراضي) متوسط. |
| `.-size-medium` | (الافتراضي) متوسط. اسم بديل مطوَّل لـ `-size-md`. |
| `.-size-sm` | صغير. |
| `.-size-small` | صغير. اسم بديل مطوَّل لـ `-size-sm`. |
...
| عنصر زائف | الوصف |
| --- | --- |
| `::placeholder` | نص العنصر النائب، بلون مكتوم يتغير عند التحويم. |
