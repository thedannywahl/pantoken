...
`.instui-toggle-group` — كشف ذو حدود مبني على `&lt;details&gt;`: صف ملخص بشيفرون ومحتوى قابل للطي.

مبني على نفس أساس `&lt;details&gt;` الأصلي مثل toggle-details؛ ضع `&lt;summary&gt;` أولاً لكي يصبح صف الرأس القابل للنقر وبقية المحتوى قابلة للطي.
...
| -------------- | --------------------------------------------------------------------------------------- |
| `::before`     | يرسم شيفرون الكشف في صف الملخص، رمز مقنع يدور للإشارة لأسفل عندما تكون المجموعة مفتوحة. |
...
- [toggle-details](/ar/api/css/toggle-details.md) — الشكل الفردي بدون حدود من نفس الكشف.
