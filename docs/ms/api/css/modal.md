...
- [modal.body](/ms/api/css/modal.body.md)
- [modal.footer](/ms/api/css/modal.footer.md)
- [modal.header](/ms/api/css/modal.header.md)

## Berkaitan

- [tray](/ms/api/css/tray.md) — A tray is the same dismissible overlay pattern, anchored to a screen edge.
