...
| --- | --- |
| `.-color-ai` | <span class="instui-pill -color-danger pantoken-doc-tag">Usang</span> — use `.-color-ai-highlight`. |
...
- [heading](/ms/api/css/heading.md) — Typography for headings rather than body text.
- [truncate](/ms/api/css/truncate.md) — Clips this text to one line or a set number of lines.
