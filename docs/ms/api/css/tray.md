...
| `.-size-regular` | <span class="instui-pill -color-danger pantoken-doc-tag">Usang</span> — use `.-size-md`. |
| `.-size-sm` | Small. |
...
- [modal](/ms/api/css/modal.md) — The same dismissible overlay pattern, centred instead of edge-pinned.
- [popover](/ms/api/css/popover.md) — The generic top-layer surface this builds on.
