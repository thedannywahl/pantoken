...
- [drawer-layout.tray](/ms/api/css/drawer-layout.tray.md)
- [tray](/ms/api/css/tray.md)

## Berkaitan

- [tray](/ms/api/css/tray.md) — A standalone edge overlay; this layout keeps tray and content in the same flow.
- [context-view](/ms/api/css/context-view.md) — A smaller anchored surface for contextual actions and detail.
