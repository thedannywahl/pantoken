...
- [text-area](/ms/api/css/text-area.md) — The multi-line counterpart with the same states and sizes.
- [number-input](/ms/api/css/number-input.md) — The numeric-entry input sharing this chrome.
- [simple-select](/ms/api/css/simple-select.md) — The native select sharing this field chrome.
- [input-group](/ms/api/css/input-group.md) — Wraps this input with leading and trailing slots.
