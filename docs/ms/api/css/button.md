...
| `.-color-primary-inverse` | <span class="instui-pill -color-danger pantoken-doc-tag">Usang</span> — use `.-on-color`. |
...
- [close-button](/ms/api/css/close-button.md) — The icon-only dismiss button.
