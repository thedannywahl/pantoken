...
- [heading](/ms/api/css/heading.md) — Place directly in the card or inside a container section.
- [button](/ms/api/css/button.md) — Place directly in the card or inside a container section.
- [img](/ms/api/css/img.md) — Place directly in the card as a media region.
- [badge](/ms/api/css/badge.md) — Place directly in the card as a status indicator.
