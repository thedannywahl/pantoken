...
- [menu.group](/ms/api/css/menu.group.md)
- [menu.item](/ms/api/css/menu.item.md)
- [menu.separator](/ms/api/css/menu.separator.md)
- [side-nav-bar.item](/ms/api/css/side-nav-bar.item.md)

## Berkaitan

- [tree-browser](/ms/api/css/tree-browser.md) — Both present nested, selectable entries.
- [simple-select](/ms/api/css/simple-select.md) — A select's dropdown reuses this menu surface.
