...
| `.-size-regular` | <span class="instui-pill -color-danger pantoken-doc-tag">Vanhentunut</span> — use `.-size-md`. |
| `.-size-sm` | Small. |
...
- [modal](/fi/api/css/modal.md) — The same dismissible overlay pattern, centred instead of edge-pinned.
- [popover](/fi/api/css/popover.md) — The generic top-layer surface this builds on.
