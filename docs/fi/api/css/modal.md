...
- [modal.body](/fi/api/css/modal.body.md)
- [modal.footer](/fi/api/css/modal.footer.md)
- [modal.header](/fi/api/css/modal.header.md)

## Liittyvät

- [tray](/fi/api/css/tray.md) — A tray is the same dismissible overlay pattern, anchored to a screen edge.
