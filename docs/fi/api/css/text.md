...
| Muokkaaja | Kuvaus |
| --- | --- |
| `.-color-ai` | <span class="instui-pill -color-danger pantoken-doc-tag">Vanhentunut</span> — use `.-color-ai-highlight`. |
...
- [heading](/fi/api/css/heading.md) — Typography for headings rather than body text.
- [truncate](/fi/api/css/truncate.md) — Clips this text to one line or a set number of lines.
