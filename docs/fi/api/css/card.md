...
- [heading](/fi/api/css/heading.md) — Place directly in the card or inside a container section.
- [button](/fi/api/css/button.md) — Place directly in the card or inside a container section.
- [img](/fi/api/css/img.md) — Place directly in the card as a media region.
- [badge](/fi/api/css/badge.md) — Place directly in the card as a status indicator.
