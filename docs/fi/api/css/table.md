...
- [table.body](/fi/api/css/table.body.md)
- [table.cell](/fi/api/css/table.cell.md)
- [table.col-header](/fi/api/css/table.col-header.md)
- [table.head](/fi/api/css/table.head.md)
- [table.row](/fi/api/css/table.row.md)
- [table.row-header](/fi/api/css/table.row-header.md)
