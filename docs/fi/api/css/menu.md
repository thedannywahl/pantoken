...
- [menu.group](/fi/api/css/menu.group.md)
- [menu.item](/fi/api/css/menu.item.md)
- [menu.separator](/fi/api/css/menu.separator.md)
- [side-nav-bar.item](/fi/api/css/side-nav-bar.item.md)

## Liittyvät

- [tree-browser](/fi/api/css/tree-browser.md) — Both present nested, selectable entries.
- [simple-select](/fi/api/css/simple-select.md) — A select's dropdown reuses this menu surface.
