...
| `.-color-primary-inverse` | <span class="instui-pill -color-danger pantoken-doc-tag">Vanhentunut</span> — use `.-on-color`. |
...
- [close-button](/fi/api/css/close-button.md) — The icon-only dismiss button.
