...
| --- | --- |
| `.-color-ai` | <span class="instui-pill -color-danger pantoken-doc-tag">Deprekereda</span> — use `.-color-ai-highlight`. |
...
- [heading](/se/api/css/heading.md) — Typography for headings rather than body text.
- [truncate](/se/api/css/truncate.md) — Clips this text to one line or a set number of lines.
