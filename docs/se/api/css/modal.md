...
- [modal.body](/se/api/css/modal.body.md)
- [modal.footer](/se/api/css/modal.footer.md)
- [modal.header](/se/api/css/modal.header.md)

## Dálkkodat

- [tray](/se/api/css/tray.md) — A tray is the same dismissible overlay pattern, anchored to a screen edge.
