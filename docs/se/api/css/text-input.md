...
- [text-area](/se/api/css/text-area.md) — The multi-line counterpart with the same states and sizes.
- [number-input](/se/api/css/number-input.md) — The numeric-entry input sharing this chrome.
- [simple-select](/se/api/css/simple-select.md) — The native select sharing this field chrome.
- [input-group](/se/api/css/input-group.md) — Wraps this input with leading and trailing slots.
