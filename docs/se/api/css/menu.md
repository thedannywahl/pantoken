...
- [menu.group](/se/api/css/menu.group.md)
- [menu.item](/se/api/css/menu.item.md)
- [menu.separator](/se/api/css/menu.separator.md)
- [side-nav-bar.item](/se/api/css/side-nav-bar.item.md)

## Dálkkodat

- [tree-browser](/se/api/css/tree-browser.md) — Both present nested, selectable entries.
- [simple-select](/se/api/css/simple-select.md) — A select's dropdown reuses this menu surface.
