...
- [drawer-layout.tray](/se/api/css/drawer-layout.tray.md)
- [tray](/se/api/css/tray.md)

## Dálkkodat

- [tray](/se/api/css/tray.md) — A standalone edge overlay; this layout keeps tray and content in the same flow.
- [context-view](/se/api/css/context-view.md) — A smaller anchored surface for contextual actions and detail.
