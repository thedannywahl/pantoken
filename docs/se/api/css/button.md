...
| `.-color-primary-inverse` | <span class="instui-pill -color-danger pantoken-doc-tag">Deprekereda</span> — use `.-on-color`. |
...
- [close-button](/se/api/css/close-button.md) — The icon-only dismiss button.
