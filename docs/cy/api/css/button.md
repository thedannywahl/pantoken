...
| `.-color-primary-inverse` | <span class="instui-pill -color-danger pantoken-doc-tag">Wedi'i henffurfio</span> — use `.-on-color`. |
...
- [close-button](/cy/api/css/close-button.md) — The icon-only dismiss button.
