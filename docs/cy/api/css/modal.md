...
- [modal.body](/cy/api/css/modal.body.md)
- [modal.footer](/cy/api/css/modal.footer.md)
- [modal.header](/cy/api/css/modal.header.md)

## Perthnasol

- [tray](/cy/api/css/tray.md) — A tray is the same dismissible overlay pattern, anchored to a screen edge.
