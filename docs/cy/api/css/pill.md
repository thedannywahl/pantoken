...
| `.-render-icon-<name>` | <span class="instui-pill -color-danger pantoken-doc-tag">Wedi'i henffurfio</span> — The former `renderIcon` prop; still works as an alias, but use `-icon-<name>` instead. |
...
- [badge](/cy/api/css/badge.md) — A badge is the count or notification counterpart.
- [tag](/cy/api/css/tag.md) — A tag is the removable, form-oriented counterpart.
