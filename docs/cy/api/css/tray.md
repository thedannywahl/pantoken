...
| `.-size-regular` | <span class="instui-pill -color-danger pantoken-doc-tag">Wedi'i henffurfio</span> — use `.-size-md`. |
| `.-size-sm` | Small. |
...
- [modal](/cy/api/css/modal.md) — The same dismissible overlay pattern, centred instead of edge-pinned.
- [popover](/cy/api/css/popover.md) — The generic top-layer surface this builds on.
