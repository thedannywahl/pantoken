...
- [heading](/cy/api/css/heading.md) — Place directly in the card or inside a container section.
- [button](/cy/api/css/button.md) — Place directly in the card or inside a container section.
- [img](/cy/api/css/img.md) — Place directly in the card as a media region.
- [badge](/cy/api/css/badge.md) — Place directly in the card as a status indicator.
