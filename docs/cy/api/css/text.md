...
| Modyfiwr | Disgrifiad |
| --- | --- |
| `.-color-ai` | <span class="instui-pill -color-danger pantoken-doc-tag">Wedi'i henffurfio</span> — use `.-color-ai-highlight`. |
...
- [heading](/cy/api/css/heading.md) — Typography for headings rather than body text.
- [truncate](/cy/api/css/truncate.md) — Clips this text to one line or a set number of lines.
