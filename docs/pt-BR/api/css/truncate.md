...
<!-- js-requirement -->
> [!TIP]
> **Requisito JS** — This component ships no CSS of its own — its markup and behavior come entirely from `@pantoken/interactions`. Its `--max-lines-auto` modifier is driven by that behavior. See the [modifier table below](#modifiers).
...
- [text](/pt-BR/api/css/text.md) — Body typography that this truncates.
