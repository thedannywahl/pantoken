...
- [drawer-layout.tray](/pt-BR/api/css/drawer-layout.tray.md)
- [tray](/pt-BR/api/css/tray.md)

## Relacionado

- [tray](/pt-BR/api/css/tray.md) — A standalone edge overlay; this layout keeps tray and content in the same flow.
- [context-view](/pt-BR/api/css/context-view.md) — A smaller anchored surface for contextual actions and detail.
