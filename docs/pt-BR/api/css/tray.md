...
- [modal](/pt-BR/api/css/modal.md) — The same dismissible overlay pattern, centred instead of edge-pinned.
- [popover](/pt-BR/api/css/popover.md) — The generic top-layer surface this builds on.
