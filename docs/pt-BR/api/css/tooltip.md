...
- [popover](/pt-BR/api/css/popover.md) — The larger, click-triggered anchored surface.
- [context-view](/pt-BR/api/css/context-view.md) — A related anchored surface with a pointer.
