...
- [text-input](/pt-BR/api/css/text-input.md) — Shares the same field chrome, states, and sizes.
- [menu](/pt-BR/api/css/menu.md) — The dropdown surface a richer select reuses.
