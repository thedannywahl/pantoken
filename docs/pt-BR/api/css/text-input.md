...
- [text-area](/pt-BR/api/css/text-area.md) — The multi-line counterpart with the same states and sizes.
- [number-input](/pt-BR/api/css/number-input.md) — The numeric-entry input sharing this chrome.
- [simple-select](/pt-BR/api/css/simple-select.md) — The native select sharing this field chrome.
- [input-group](/pt-BR/api/css/input-group.md) — Wraps this input with leading and trailing slots.
