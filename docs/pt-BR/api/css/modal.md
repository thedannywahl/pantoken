...
<!-- js-requirement -->
> [!TIP]
> **Aprimoramento JS** — This component's CSS renders and works on its own; pair it with `@pantoken/interactions` to add the interactive behavior. See the [modifier table below](#modifiers).
...
- [modal.body](/pt-BR/api/css/modal.body.md)
- [modal.footer](/pt-BR/api/css/modal.footer.md)
- [modal.header](/pt-BR/api/css/modal.header.md)

## Relacionado

- [tray](/pt-BR/api/css/tray.md) — A tray is the same dismissible overlay pattern, anchored to a screen edge.
