...
- [menu.group](/pt-BR/api/css/menu.group.md)
- [menu.item](/pt-BR/api/css/menu.item.md)
- [menu.separator](/pt-BR/api/css/menu.separator.md)
- [side-nav-bar.item](/pt-BR/api/css/side-nav-bar.item.md)

## Relacionado

- [tree-browser](/pt-BR/api/css/tree-browser.md) — Both present nested, selectable entries.
- [simple-select](/pt-BR/api/css/simple-select.md) — A select's dropdown reuses this menu surface.
