...
- [agent-shell](/pt-BR/api/css/agent-shell.md)
- [breadcrumb](/pt-BR/api/css/breadcrumb.md)
- [button](/pt-BR/api/css/button.md)
- [card](/pt-BR/api/css/card.md)
- [drawer-layout.content](/pt-BR/api/css/drawer-layout.content.md)
- [list](/pt-BR/api/css/list.md)
- [modal.header](/pt-BR/api/css/modal.header.md)
- [side-nav-bar](/pt-BR/api/css/side-nav-bar.md)
- [tabs](/pt-BR/api/css/tabs.md)
- [tabs.panel](/pt-BR/api/css/tabs.panel.md)
