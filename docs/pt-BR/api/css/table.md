...
- [table.body](/pt-BR/api/css/table.body.md)
- [table.cell](/pt-BR/api/css/table.cell.md)
- [table.col-header](/pt-BR/api/css/table.col-header.md)
- [table.head](/pt-BR/api/css/table.head.md)
- [table.row](/pt-BR/api/css/table.row.md)
- [table.row-header](/pt-BR/api/css/table.row-header.md)
