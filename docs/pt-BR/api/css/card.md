...
- [heading](/pt-BR/api/css/heading.md) — Place directly in the card or inside a container section.
- [button](/pt-BR/api/css/button.md) — Place directly in the card or inside a container section.
- [img](/pt-BR/api/css/img.md) — Place directly in the card as a media region.
- [badge](/pt-BR/api/css/badge.md) — Place directly in the card as a status indicator.
