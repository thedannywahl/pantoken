...
- [text-input](/zh-Hans/api/css/text-input.md) — Shares the same field chrome, states, and sizes.
- [menu](/zh-Hans/api/css/menu.md) — The dropdown surface a richer select reuses.
