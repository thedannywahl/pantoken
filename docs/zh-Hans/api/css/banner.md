...
- [alert](/zh-Hans/api/css/alert.md) — A non-dismissible, status-coloured counterpart for inline messages.
- [close-button](/zh-Hans/api/css/close-button.md) — The dismiss control a banner may include.
