...
- [heading](/zh-Hans/api/css/heading.md) — Place directly in the card or inside a container section.
- [button](/zh-Hans/api/css/button.md) — Place directly in the card or inside a container section.
- [img](/zh-Hans/api/css/img.md) — Place directly in the card as a media region.
- [badge](/zh-Hans/api/css/badge.md) — Place directly in the card as a status indicator.
