...
- [modal.body](/zh-Hans/api/css/modal.body.md)
- [modal.footer](/zh-Hans/api/css/modal.footer.md)
- [modal.header](/zh-Hans/api/css/modal.header.md)

## 相关

- [tray](/zh-Hans/api/css/tray.md) — A tray is the same dismissible overlay pattern, anchored to a screen edge.
