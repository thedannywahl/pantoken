...
| `.-size-regular` | <span class="instui-pill -color-danger pantoken-doc-tag">已弃用</span> — use `.-size-md`. |
| `.-size-sm` | Small. |
...
- [modal](/zh-Hans/api/css/modal.md) — The same dismissible overlay pattern, centred instead of edge-pinned.
- [popover](/zh-Hans/api/css/popover.md) — The generic top-layer surface this builds on.
