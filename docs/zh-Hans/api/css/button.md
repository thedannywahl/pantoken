...
| `.-color-primary-inverse` | <span class="instui-pill -color-danger pantoken-doc-tag">已弃用</span> — use `.-on-color`. |
...
- [close-button](/zh-Hans/api/css/close-button.md) — The icon-only dismiss button.
