...
<!-- js-requirement -->
> [!TIP]
> **JS 要求** — This component ships no CSS of its own — its markup and behavior come entirely from `@pantoken/interactions`. Its `--max-lines-auto` modifier is driven by that behavior. See the [modifier table below](#modifiers).
...
- [text](/zh-Hans/api/css/text.md) — Body typography that this truncates.
