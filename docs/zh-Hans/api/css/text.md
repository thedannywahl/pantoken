...
| 修饰符 | 描述 |
| --- | --- |
| `.-color-ai` | <span class="instui-pill -color-danger pantoken-doc-tag">已弃用</span> — use `.-color-ai-highlight`. |
...
- [heading](/zh-Hans/api/css/heading.md) — Typography for headings rather than body text.
- [truncate](/zh-Hans/api/css/truncate.md) — Clips this text to one line or a set number of lines.
