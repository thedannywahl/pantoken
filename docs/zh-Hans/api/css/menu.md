...
- [menu.group](/zh-Hans/api/css/menu.group.md)
- [menu.item](/zh-Hans/api/css/menu.item.md)
- [menu.separator](/zh-Hans/api/css/menu.separator.md)
- [side-nav-bar.item](/zh-Hans/api/css/side-nav-bar.item.md)

## 相关

- [tree-browser](/zh-Hans/api/css/tree-browser.md) — Both present nested, selectable entries.
- [simple-select](/zh-Hans/api/css/simple-select.md) — A select's dropdown reuses this menu surface.
