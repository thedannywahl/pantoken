...
- [text-area](/hi/api/css/text-area.md) — The multi-line counterpart with the same states and sizes.
- [number-input](/hi/api/css/number-input.md) — The numeric-entry input sharing this chrome.
- [simple-select](/hi/api/css/simple-select.md) — The native select sharing this field chrome.
- [input-group](/hi/api/css/input-group.md) — Wraps this input with leading and trailing slots.
