...
- [menu.group](/hi/api/css/menu.group.md)
- [menu.item](/hi/api/css/menu.item.md)
- [menu.separator](/hi/api/css/menu.separator.md)
- [side-nav-bar.item](/hi/api/css/side-nav-bar.item.md)

## संबंधित

- [tree-browser](/hi/api/css/tree-browser.md) — Both present nested, selectable entries.
- [simple-select](/hi/api/css/simple-select.md) — A select's dropdown reuses this menu surface.
