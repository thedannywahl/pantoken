...
| `.-size-regular` | <span class="instui-pill -color-danger pantoken-doc-tag">अप्रमाणित</span> — use `.-size-md`. |
| `.-size-sm` | Small. |
...
- [modal](/hi/api/css/modal.md) — The same dismissible overlay pattern, centred instead of edge-pinned.
- [popover](/hi/api/css/popover.md) — The generic top-layer surface this builds on.
