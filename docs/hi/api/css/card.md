...
- [heading](/hi/api/css/heading.md) — Place directly in the card or inside a container section.
- [button](/hi/api/css/button.md) — Place directly in the card or inside a container section.
- [img](/hi/api/css/img.md) — Place directly in the card as a media region.
- [badge](/hi/api/css/badge.md) — Place directly in the card as a status indicator.
