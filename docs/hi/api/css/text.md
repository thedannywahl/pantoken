...
| मॉडिफायर | विवरण |
| --- | --- |
| `.-color-ai` | <span class="instui-pill -color-danger pantoken-doc-tag">अप्रमाणित</span> — use `.-color-ai-highlight`. |
...
- [heading](/hi/api/css/heading.md) — Typography for headings rather than body text.
- [truncate](/hi/api/css/truncate.md) — Clips this text to one line or a set number of lines.
