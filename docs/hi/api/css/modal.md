...
- [modal.body](/hi/api/css/modal.body.md)
- [modal.footer](/hi/api/css/modal.footer.md)
- [modal.header](/hi/api/css/modal.header.md)

## संबंधित

- [tray](/hi/api/css/tray.md) — A tray is the same dismissible overlay pattern, anchored to a screen edge.
