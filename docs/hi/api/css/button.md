...
| `.-color-primary-inverse` | <span class="instui-pill -color-danger pantoken-doc-tag">अप्रमाणित</span> — use `.-on-color`. |
...
- [close-button](/hi/api/css/close-button.md) — The icon-only dismiss button.
