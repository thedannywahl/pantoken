...
features:
  ...
  - icon:
    ...
    title: सबसे छोटा पैकेज उपयोग करें
    details: स्टाइलशीट के लिए केवल @pantoken/css इंस्टॉल करें, हुक्स और आइकनों के लिए @pantoken/react, या Tailwind, Panda, या MUI के लिए एक बंडलर प्रीसेट।
  - icon:
