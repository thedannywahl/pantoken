...
- [modal.body](/mi/api/css/modal.body.md)
- [modal.footer](/mi/api/css/modal.footer.md)
- [modal.header](/mi/api/css/modal.header.md)

## Hono

- [tray](/mi/api/css/tray.md) — A tray is the same dismissible overlay pattern, anchored to a screen edge.
