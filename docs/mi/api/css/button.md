...
| `.-color-primary-inverse` | <span class="instui-pill -color-danger pantoken-doc-tag">Kua tukuna</span> — use `.-on-color`. |
...
- [close-button](/mi/api/css/close-button.md) — The icon-only dismiss button.
