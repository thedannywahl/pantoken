...
| --- | --- |
| `.-color-ai` | <span class="instui-pill -color-danger pantoken-doc-tag">Kua tukuna</span> — use `.-color-ai-highlight`. |
...
- [heading](/mi/api/css/heading.md) — Typography for headings rather than body text.
- [truncate](/mi/api/css/truncate.md) — Clips this text to one line or a set number of lines.
