...
- [menu.group](/mi/api/css/menu.group.md)
- [menu.item](/mi/api/css/menu.item.md)
- [menu.separator](/mi/api/css/menu.separator.md)
- [side-nav-bar.item](/mi/api/css/side-nav-bar.item.md)

## Hono

- [tree-browser](/mi/api/css/tree-browser.md) — Both present nested, selectable entries.
- [simple-select](/mi/api/css/simple-select.md) — A select's dropdown reuses this menu surface.
