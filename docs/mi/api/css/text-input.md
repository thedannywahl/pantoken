...
- [text-area](/mi/api/css/text-area.md) — The multi-line counterpart with the same states and sizes.
- [number-input](/mi/api/css/number-input.md) — The numeric-entry input sharing this chrome.
- [simple-select](/mi/api/css/simple-select.md) — The native select sharing this field chrome.
- [input-group](/mi/api/css/input-group.md) — Wraps this input with leading and trailing slots.
