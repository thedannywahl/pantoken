...
- [heading](/mi/api/css/heading.md) — Place directly in the card or inside a container section.
- [button](/mi/api/css/button.md) — Place directly in the card or inside a container section.
- [img](/mi/api/css/img.md) — Place directly in the card as a media region.
- [badge](/mi/api/css/badge.md) — Place directly in the card as a status indicator.
