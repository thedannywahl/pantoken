...
| `.-size-regular` | <span class="instui-pill -color-danger pantoken-doc-tag">Kua tukuna</span> — use `.-size-md`. |
| `.-size-sm` | Small. |
...
- [modal](/mi/api/css/modal.md) — The same dismissible overlay pattern, centred instead of edge-pinned.
- [popover](/mi/api/css/popover.md) — The generic top-layer surface this builds on.
