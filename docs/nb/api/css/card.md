...
- [heading](/nb/api/css/heading.md) — Place directly in the card or inside a container section.
- [button](/nb/api/css/button.md) — Place directly in the card or inside a container section.
- [img](/nb/api/css/img.md) — Place directly in the card as a media region.
- [badge](/nb/api/css/badge.md) — Place directly in the card as a status indicator.
