...
- [menu.group](/nb/api/css/menu.group.md)
- [menu.item](/nb/api/css/menu.item.md)
- [menu.separator](/nb/api/css/menu.separator.md)
- [side-nav-bar.item](/nb/api/css/side-nav-bar.item.md)

## Relatert

- [tree-browser](/nb/api/css/tree-browser.md) — Both present nested, selectable entries.
- [simple-select](/nb/api/css/simple-select.md) — A select's dropdown reuses this menu surface.
