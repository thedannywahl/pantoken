...
- [popover](/nb/api/css/popover.md) — The larger, click-triggered anchored surface.
- [context-view](/nb/api/css/context-view.md) — A related anchored surface with a pointer.
