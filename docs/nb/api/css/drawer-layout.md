...
- [drawer-layout.tray](/nb/api/css/drawer-layout.tray.md)
- [tray](/nb/api/css/tray.md)

## Relatert

- [tray](/nb/api/css/tray.md) — A standalone edge overlay; this layout keeps tray and content in the same flow.
- [context-view](/nb/api/css/context-view.md) — A smaller anchored surface for contextual actions and detail.
