...
- [modal.body](/nb/api/css/modal.body.md)
- [modal.footer](/nb/api/css/modal.footer.md)
- [modal.header](/nb/api/css/modal.header.md)

## Relatert

- [tray](/nb/api/css/tray.md) — A tray is the same dismissible overlay pattern, anchored to a screen edge.
