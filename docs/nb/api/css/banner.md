...
- [alert](/nb/api/css/alert.md) — A non-dismissible, status-coloured counterpart for inline messages.
- [close-button](/nb/api/css/close-button.md) — The dismiss control a banner may include.
