...
- [form-field](/nb/api/css/form-field.md)
- [form-field-messages](/nb/api/css/form-field-messages.md)

## Relatert

- [form-field](/nb/api/css/form-field.md) — The single field this group repeats.
- [radio-input-group](/nb/api/css/radio-input-group.md) — Groups radio inputs under a legend.
