...
- [modal.body](/ga/api/css/modal.body.md)
- [modal.footer](/ga/api/css/modal.footer.md)
- [modal.header](/ga/api/css/modal.header.md)

## Gaolmhar

- [tray](/ga/api/css/tray.md) — A tray is the same dismissible overlay pattern, anchored to a screen edge.
