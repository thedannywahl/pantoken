...
- [heading](/ga/api/css/heading.md) — Place directly in the card or inside a container section.
- [button](/ga/api/css/button.md) — Place directly in the card or inside a container section.
- [img](/ga/api/css/img.md) — Place directly in the card as a media region.
- [badge](/ga/api/css/badge.md) — Place directly in the card as a status indicator.
