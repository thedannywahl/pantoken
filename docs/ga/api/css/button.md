...
| `.-color-primary-inverse` | <span class="instui-pill -color-danger pantoken-doc-tag">As dáta</span> — use `.-on-color`. |
...
- [close-button](/ga/api/css/close-button.md) — The icon-only dismiss button.
