...
| Modhnóir | Cur síos |
| --- | --- |
| `.-color-ai` | <span class="instui-pill -color-danger pantoken-doc-tag">As dáta</span> — use `.-color-ai-highlight`. |
...
- [heading](/ga/api/css/heading.md) — Typography for headings rather than body text.
- [truncate](/ga/api/css/truncate.md) — Clips this text to one line or a set number of lines.
