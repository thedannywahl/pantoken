...
- [alert](/ga/api/css/alert.md) — A non-dismissible, status-coloured counterpart for inline messages.
- [close-button](/ga/api/css/close-button.md) — The dismiss control a banner may include.
