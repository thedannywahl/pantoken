...
- [menu.group](/ga/api/css/menu.group.md)
- [menu.item](/ga/api/css/menu.item.md)
- [menu.separator](/ga/api/css/menu.separator.md)
- [side-nav-bar.item](/ga/api/css/side-nav-bar.item.md)

## Gaolmhar

- [tree-browser](/ga/api/css/tree-browser.md) — Both present nested, selectable entries.
- [simple-select](/ga/api/css/simple-select.md) — A select's dropdown reuses this menu surface.
