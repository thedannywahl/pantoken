...
| `.-size-regular` | <span class="instui-pill -color-danger pantoken-doc-tag">As dáta</span> — use `.-size-md`. |
| `.-size-sm` | Small. |
...
- [modal](/ga/api/css/modal.md) — The same dismissible overlay pattern, centred instead of edge-pinned.
- [popover](/ga/api/css/popover.md) — The generic top-layer surface this builds on.
