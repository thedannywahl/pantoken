...
| --- | --- |
| `.-color-ai` | <span class="instui-pill -color-danger pantoken-doc-tag">Deprecato</span> — use `.-color-ai-highlight`. |
...
- [heading](/it/api/css/heading.md) — Typography for headings rather than body text.
- [truncate](/it/api/css/truncate.md) — Clips this text to one line or a set number of lines.
