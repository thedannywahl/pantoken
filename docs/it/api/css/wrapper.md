...
- [agent-shell](/it/api/css/agent-shell.md)
- [breadcrumb](/it/api/css/breadcrumb.md)
- [button](/it/api/css/button.md)
- [card](/it/api/css/card.md)
- [drawer-layout.content](/it/api/css/drawer-layout.content.md)
- [list](/it/api/css/list.md)
- [modal.header](/it/api/css/modal.header.md)
- [side-nav-bar](/it/api/css/side-nav-bar.md)
- [tabs](/it/api/css/tabs.md)
- [tabs.panel](/it/api/css/tabs.panel.md)
