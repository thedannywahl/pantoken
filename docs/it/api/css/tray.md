...
| `.-size-regular` | <span class="instui-pill -color-danger pantoken-doc-tag">Deprecato</span> — use `.-size-md`. |
| `.-size-sm` | Small. |
...
- [modal](/it/api/css/modal.md) — The same dismissible overlay pattern, centred instead of edge-pinned.
- [popover](/it/api/css/popover.md) — The generic top-layer surface this builds on.
