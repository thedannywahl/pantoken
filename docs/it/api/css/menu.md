...
- [menu.group](/it/api/css/menu.group.md)
- [menu.item](/it/api/css/menu.item.md)
- [menu.separator](/it/api/css/menu.separator.md)
- [side-nav-bar.item](/it/api/css/side-nav-bar.item.md)

## Correlati

- [tree-browser](/it/api/css/tree-browser.md) — Both present nested, selectable entries.
- [simple-select](/it/api/css/simple-select.md) — A select's dropdown reuses this menu surface.
