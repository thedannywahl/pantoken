...
- [modal.body](/it/api/css/modal.body.md)
- [modal.footer](/it/api/css/modal.footer.md)
- [modal.header](/it/api/css/modal.header.md)

## Correlati

- [tray](/it/api/css/tray.md) — A tray is the same dismissible overlay pattern, anchored to a screen edge.
