...
- [heading](/it/api/css/heading.md) — Place directly in the card or inside a container section.
- [button](/it/api/css/button.md) — Place directly in the card or inside a container section.
- [img](/it/api/css/img.md) — Place directly in the card as a media region.
- [badge](/it/api/css/badge.md) — Place directly in the card as a status indicator.
