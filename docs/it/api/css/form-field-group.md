...
- [form-field](/it/api/css/form-field.md)
- [form-field-messages](/it/api/css/form-field-messages.md)

## Correlati

- [form-field](/it/api/css/form-field.md) — The single field this group repeats.
- [radio-input-group](/it/api/css/radio-input-group.md) — Groups radio inputs under a legend.
