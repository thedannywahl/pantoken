...
| `.-color-primary-inverse` | <span class="instui-pill -color-danger pantoken-doc-tag">Deprecato</span> — use `.-on-color`. |
...
- [close-button](/it/api/css/close-button.md) — The icon-only dismiss button.
