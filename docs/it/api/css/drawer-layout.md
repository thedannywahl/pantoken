...
- [drawer-layout.tray](/it/api/css/drawer-layout.tray.md)
- [tray](/it/api/css/tray.md)

## Correlati

- [tray](/it/api/css/tray.md) — A standalone edge overlay; this layout keeps tray and content in the same flow.
- [context-view](/it/api/css/context-view.md) — A smaller anchored surface for contextual actions and detail.
