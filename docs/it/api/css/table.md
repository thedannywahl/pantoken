...
- [table.body](/it/api/css/table.body.md)
- [table.cell](/it/api/css/table.cell.md)
- [table.col-header](/it/api/css/table.col-header.md)
- [table.head](/it/api/css/table.head.md)
- [table.row](/it/api/css/table.row.md)
- [table.row-header](/it/api/css/table.row-header.md)
