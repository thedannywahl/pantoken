...
- [heading](/ja/api/css/heading.md) — Place directly in the card or inside a container section.
- [button](/ja/api/css/button.md) — Place directly in the card or inside a container section.
- [img](/ja/api/css/img.md) — Place directly in the card as a media region.
- [badge](/ja/api/css/badge.md) — Place directly in the card as a status indicator.
