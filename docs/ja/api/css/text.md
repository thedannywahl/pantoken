...
| 修飾子 | 説明 |
| --- | --- |
| `.-color-ai` | <span class="instui-pill -color-danger pantoken-doc-tag">非推奨</span> — use `.-color-ai-highlight`. |
...
- [heading](/ja/api/css/heading.md) — Typography for headings rather than body text.
- [truncate](/ja/api/css/truncate.md) — Clips this text to one line or a set number of lines.
