...
- [modal.body](/ja/api/css/modal.body.md)
- [modal.footer](/ja/api/css/modal.footer.md)
- [modal.header](/ja/api/css/modal.header.md)

## 関連項目

- [tray](/ja/api/css/tray.md) — A tray is the same dismissible overlay pattern, anchored to a screen edge.
