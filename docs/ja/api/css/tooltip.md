...
- [popover](/ja/api/css/popover.md) — The larger, click-triggered anchored surface.
- [context-view](/ja/api/css/context-view.md) — A related anchored surface with a pointer.
