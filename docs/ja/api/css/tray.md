...
| `.-size-regular` | <span class="instui-pill -color-danger pantoken-doc-tag">非推奨</span> — use `.-size-md`. |
| `.-size-sm` | Small. |
...
- [modal](/ja/api/css/modal.md) — The same dismissible overlay pattern, centred instead of edge-pinned.
- [popover](/ja/api/css/popover.md) — The generic top-layer surface this builds on.
