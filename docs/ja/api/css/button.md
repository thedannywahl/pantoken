...
| `.-color-primary-inverse` | <span class="instui-pill -color-danger pantoken-doc-tag">非推奨</span> — use `.-on-color`. |
...
- [close-button](/ja/api/css/close-button.md) — The icon-only dismiss button.
