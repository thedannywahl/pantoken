...
`.instui-toggle-group` — Una revelació delimitada construïda sobre `&lt;details&gt;`: una fila de resum de xevró i contingut col·lapsable.

Construït sobre la mateixa base nativa de `&lt;details&gt;` que toggle-details; col·loca el `&lt;summary&gt;` primer perquè es converteixi en la fila de capçalera clicable i la resta sigui el contingut col·lapsable.

**Font:** [toggle-group.css](https://github.com/thedannywahl/pantoken/blob/main/formats/components/src/components/toggle-group/toggle-group.css)
...
| -------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| `::before`     | Dibuixa el xevró de revelació de la fila de resum, un graf emmascarat que gira per assenyalar cap avall quan el grup està obert. |
...
- [toggle-details](/ca/api/css/toggle-details.md) — La forma única i sense vora de la mateixa revelació.
