...
`*` — La reinicialització global voluntària: `box-sizing`, la superfície de la pàgina, el color i la font del text base, `color-scheme`, i les configuracions per defecte d'enllaç.

**Font:** [base.css](https://github.com/thedannywahl/pantoken/blob/main/formats/components/src/rules/base/base.css)
...
| --- | --- |
| `::after` | Inclòs en la reinicialització universal `box-sizing: border-box` perquè les seves mides de caixa generades siguin previsibles. |
| `::before` | Inclòs en la reinicialització universal `box-sizing: border-box` perquè les seves mides de caixa generades siguin previsibles. |
| `::selection` | Tinya el text destacat amb un color de navegació primari translúcid. |
