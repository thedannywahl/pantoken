...
`.instui-form-field-messages` — Missatges d'ajuda i validació de camps — pista, error, èxit i només lector de pantalla — amb un símbol en error i èxit.

Estableix el seu propi `gap` entre missatges apilats; encadenar un modificador d'utilitat d'espaiament `-gap-*` sobrescriu aquest valor incorporat.

**Font:** [form-field-messages.css](https://github.com/thedannywahl/pantoken/blob/main/formats/components/src/components/form-field-messages/form-field-messages.css)

## Accessibility

Un missatge `-type-screenreader-only` es mostra amagat visualment però es manté a l'arbre d'accessibilitat, de manera que es segueix anunciant; aparelleu els missatges d'error i d'èxit amb el camp mitjançant aria-describedby perquè la tecnologia d'assistència els llegeixi amb el control.
...
| Part                         | Description                                                                                                |
| ---------------------------- | ---------------------------------------------------------------------------------------------------------- |
| `.instui-form-field-message` | Un missatge individual; el seu `-type-*` tria la variant de pista, error, èxit o només lector de pantalla. |

## Pseudo-elements

| Pseudo-element | Description                                                                                                                                       |
| -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| `::before`     | Renderitza el símbol indicador d'estat en els missatges d'error i d'èxit: un cercle d'alerta pels errors i un cercle de verificació per a l'èxit. |
...
- [form-field](/ca/api/css/form-field.md) — Envolup una etiqueta, controls i aquests missatges.
