...
`.instui-tree-browser` — Un arbre de revelació de col·leccions imbricades i elements full, amb xevrons rotatius.

Cada col·lecció és un `&lt;details&gt;` natiu; imbricar-los els uns dins dels altres construeix l'arbre, i el navegador maneja l'obertura i tancament de cada branca.

**Font:** [tree-browser.css](https://github.com/thedannywahl/pantoken/blob/main/formats/components/src/components/tree-browser/tree-browser.css)

## Accessibilitat

Marca l'arrel amb role="tree" i cada llista imbricada amb role="group".
...
| --- | --- |
| `.-icon-*` | Representa icones de glifo de carpeta/fitxer en resums i elements full. |
...
| Part | Descripció |
| --- | --- |
| `.item` | Una entrada full a l'arbre. |

## Pseudoelements

| Pseudoelement | Descripció |
| --- | --- |
| `::before` | Dibuixa el xevró de revelació de cada col·lecció, un graf emmascarat que gira per assenyalar cap avall quan la branca està oberta. |
...
- [menu](/ca/api/css/menu.md) — Ambdós presenten entrades niuades, seleccionables.
