...
> [!TIP]
> **JS Requirement** — Aquest component no inclou CSS propi — el seu codi i comportament provenen completament de `@pantoken/interactions`. El seu modificador `--max-lines-auto` depèn d'aquest comportament. Consulteu la [taula de modificadors a continuació](#modifiers).
