...
`.instui-calendar` — Una graella de mes estàtica amb navegació, encapçalaments de dia de la setmana i cel·les de dia.

Consulteu el membre `calendar.day` per a les cel·les de dia individuals.

**Font:** [calendar.css](https://github.com/thedannywahl/pantoken/blob/main/formats/components/src/components/calendar/calendar.css)

## Accessibility

Exposa la graella amb `role="table"` i un `aria-label` descriptiu, i dona a cada botó de navegació el seu propi `aria-label`.
...
| Part       | Description                                        |
| ---------- | -------------------------------------------------- |
| `.grid`    | La graella de dia de set columnes.                 |
| `.nav`     | La fila de navegació del mes.                      |
| `.weekday` | Un encapçalament de columna del dia de la setmana. |
...
- [calendar.day](/ca/api/css/calendar.day.md)
