...
- [popover](/ko/api/css/popover.md) — The larger, click-triggered anchored surface.
- [context-view](/ko/api/css/context-view.md) — A related anchored surface with a pointer.
