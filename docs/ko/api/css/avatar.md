...
| 수정자 | 설명 |
| --- | --- |
| `.-color-accent1` | <span class="instui-pill -color-danger pantoken-doc-tag">더 이상 사용되지 않음</span> — use `.-color-blue`. |
| `.-color-accent2` | <span class="instui-pill -color-danger pantoken-doc-tag">더 이상 사용되지 않음</span> — use `.-color-green`. |
| `.-color-accent3` | <span class="instui-pill -color-danger pantoken-doc-tag">더 이상 사용되지 않음</span> — use `.-color-red`. |
| `.-color-accent4` | <span class="instui-pill -color-danger pantoken-doc-tag">더 이상 사용되지 않음</span> — use `.-color-orange`. |
| `.-color-accent5` | <span class="instui-pill -color-danger pantoken-doc-tag">더 이상 사용되지 않음</span> — use `.-color-ash`. |
| `.-color-accent6` | <span class="instui-pill -color-danger pantoken-doc-tag">더 이상 사용되지 않음</span> — use `.-color-grey`. |
...
- [byline](/ko/api/css/byline.md) — Can host an avatar as its leading hero figure.
