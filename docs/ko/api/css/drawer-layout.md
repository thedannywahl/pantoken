...
- [drawer-layout.content](/ko/api/css/drawer-layout.content.md)
- [drawer-layout.tray](/ko/api/css/drawer-layout.tray.md)
- [tray](/ko/api/css/tray.md)

## 관련 항목

- [tray](/ko/api/css/tray.md) — A standalone edge overlay; this layout keeps tray and content in the same flow.
- [context-view](/ko/api/css/context-view.md) — A smaller anchored surface for contextual actions and detail.
