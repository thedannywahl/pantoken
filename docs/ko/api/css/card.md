...
- [heading](/ko/api/css/heading.md) — Place directly in the card or inside a container section.
- [button](/ko/api/css/button.md) — Place directly in the card or inside a container section.
- [img](/ko/api/css/img.md) — Place directly in the card as a media region.
- [badge](/ko/api/css/badge.md) — Place directly in the card as a status indicator.
