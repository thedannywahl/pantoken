...
- [table.body](/ko/api/css/table.body.md)
- [table.cell](/ko/api/css/table.cell.md)
- [table.col-header](/ko/api/css/table.col-header.md)
- [table.head](/ko/api/css/table.head.md)
- [table.row](/ko/api/css/table.row.md)
- [table.row-header](/ko/api/css/table.row-header.md)
