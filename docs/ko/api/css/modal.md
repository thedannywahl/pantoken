...
- [modal.body](/ko/api/css/modal.body.md)
- [modal.footer](/ko/api/css/modal.footer.md)
- [modal.header](/ko/api/css/modal.header.md)

## 관련 항목

- [tray](/ko/api/css/tray.md) — A tray is the same dismissible overlay pattern, anchored to a screen edge.
