...
| `.-size-regular` | <span class="instui-pill -color-danger pantoken-doc-tag">더 이상 사용되지 않음</span> — use `.-size-md`. |
| `.-size-sm` | Small. |
...
- [modal](/ko/api/css/modal.md) — The same dismissible overlay pattern, centred instead of edge-pinned.
- [popover](/ko/api/css/popover.md) — The generic top-layer surface this builds on.
