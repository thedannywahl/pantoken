...
| `.-color-primary-inverse` | <span class="instui-pill -color-danger pantoken-doc-tag">Không khuyến nghị</span> — use `.-on-color`. |
...
- [close-button](/vi/api/css/close-button.md) — The icon-only dismiss button.
