...
| `.-size-regular` | <span class="instui-pill -color-danger pantoken-doc-tag">Không khuyến nghị</span> — use `.-size-md`. |
| `.-size-sm` | Small. |
...
- [modal](/vi/api/css/modal.md) — The same dismissible overlay pattern, centred instead of edge-pinned.
- [popover](/vi/api/css/popover.md) — The generic top-layer surface this builds on.
