...
| `.-render-icon-<name>` | <span class="instui-pill -color-danger pantoken-doc-tag">Không khuyến nghị</span> — The former `renderIcon` prop; still works as an alias, but use `-icon-<name>` instead. |
...
- [badge](/vi/api/css/badge.md) — A badge is the count or notification counterpart.
- [tag](/vi/api/css/tag.md) — A tag is the removable, form-oriented counterpart.
