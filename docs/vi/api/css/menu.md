...
- [menu.group](/vi/api/css/menu.group.md)
- [menu.item](/vi/api/css/menu.item.md)
- [menu.separator](/vi/api/css/menu.separator.md)
- [side-nav-bar.item](/vi/api/css/side-nav-bar.item.md)

## Liên quan

- [tree-browser](/vi/api/css/tree-browser.md) — Both present nested, selectable entries.
- [simple-select](/vi/api/css/simple-select.md) — A select's dropdown reuses this menu surface.
