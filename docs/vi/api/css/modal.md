...
- [modal.body](/vi/api/css/modal.body.md)
- [modal.footer](/vi/api/css/modal.footer.md)
- [modal.header](/vi/api/css/modal.header.md)

## Liên quan

- [tray](/vi/api/css/tray.md) — A tray is the same dismissible overlay pattern, anchored to a screen edge.
