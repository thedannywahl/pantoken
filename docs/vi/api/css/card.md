...
- [heading](/vi/api/css/heading.md) — Place directly in the card or inside a container section.
- [button](/vi/api/css/button.md) — Place directly in the card or inside a container section.
- [img](/vi/api/css/img.md) — Place directly in the card as a media region.
- [badge](/vi/api/css/badge.md) — Place directly in the card as a status indicator.
