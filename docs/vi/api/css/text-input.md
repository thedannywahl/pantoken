...
- [text-area](/vi/api/css/text-area.md) — The multi-line counterpart with the same states and sizes.
- [number-input](/vi/api/css/number-input.md) — The numeric-entry input sharing this chrome.
- [simple-select](/vi/api/css/simple-select.md) — The native select sharing this field chrome.
- [input-group](/vi/api/css/input-group.md) — Wraps this input with leading and trailing slots.
