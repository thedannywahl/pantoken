...
| Bộ sửa | Mô tả |
| --- | --- |
| `.-color-ai` | <span class="instui-pill -color-danger pantoken-doc-tag">Không khuyến nghị</span> — use `.-color-ai-highlight`. |
...
- [heading](/vi/api/css/heading.md) — Typography for headings rather than body text.
- [truncate](/vi/api/css/truncate.md) — Clips this text to one line or a set number of lines.
