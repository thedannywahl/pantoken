...
- [menu.group](/el/api/css/menu.group.md)
- [menu.item](/el/api/css/menu.item.md)
- [menu.separator](/el/api/css/menu.separator.md)
- [side-nav-bar.item](/el/api/css/side-nav-bar.item.md)

## Σχετιζόμενα

- [tree-browser](/el/api/css/tree-browser.md) — Both present nested, selectable entries.
- [simple-select](/el/api/css/simple-select.md) — A select's dropdown reuses this menu surface.
