...
| --- | --- |
| `.-color-ai` | <span class="instui-pill -color-danger pantoken-doc-tag">Καταργημένο</span> — use `.-color-ai-highlight`. |
...
- [heading](/el/api/css/heading.md) — Typography for headings rather than body text.
- [truncate](/el/api/css/truncate.md) — Clips this text to one line or a set number of lines.
