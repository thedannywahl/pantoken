...
- [drawer-layout.tray](/el/api/css/drawer-layout.tray.md)
- [tray](/el/api/css/tray.md)

## Σχετιζόμενα

- [tray](/el/api/css/tray.md) — A standalone edge overlay; this layout keeps tray and content in the same flow.
- [context-view](/el/api/css/context-view.md) — A smaller anchored surface for contextual actions and detail.
