...
| `.-color-primary-inverse` | <span class="instui-pill -color-danger pantoken-doc-tag">Καταργημένο</span> — use `.-on-color`. |
...
- [close-button](/el/api/css/close-button.md) — The icon-only dismiss button.
