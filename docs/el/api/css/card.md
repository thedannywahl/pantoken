...
- [heading](/el/api/css/heading.md) — Place directly in the card or inside a container section.
- [button](/el/api/css/button.md) — Place directly in the card or inside a container section.
- [img](/el/api/css/img.md) — Place directly in the card as a media region.
- [badge](/el/api/css/badge.md) — Place directly in the card as a status indicator.
