...
| `.-size-regular` | <span class="instui-pill -color-danger pantoken-doc-tag">Καταργημένο</span> — use `.-size-md`. |
| `.-size-sm` | Small. |
...
- [modal](/el/api/css/modal.md) — The same dismissible overlay pattern, centred instead of edge-pinned.
- [popover](/el/api/css/popover.md) — The generic top-layer surface this builds on.
