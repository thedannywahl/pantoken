...
- [modal.body](/el/api/css/modal.body.md)
- [modal.footer](/el/api/css/modal.footer.md)
- [modal.header](/el/api/css/modal.header.md)

## Σχετιζόμενα

- [tray](/el/api/css/tray.md) — A tray is the same dismissible overlay pattern, anchored to a screen edge.
