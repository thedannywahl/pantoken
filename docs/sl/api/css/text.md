...
| Modifikator | Opis |
| --- | --- |
| `.-color-ai` | <span class="instui-pill -color-danger pantoken-doc-tag">Zastarelo</span> — use `.-color-ai-highlight`. |
...
- [heading](/sl/api/css/heading.md) — Typography for headings rather than body text.
- [truncate](/sl/api/css/truncate.md) — Clips this text to one line or a set number of lines.
