...
| `.-color-primary-inverse` | <span class="instui-pill -color-danger pantoken-doc-tag">Zastarelo</span> — use `.-on-color`. |
...
- [close-button](/sl/api/css/close-button.md) — The icon-only dismiss button.
