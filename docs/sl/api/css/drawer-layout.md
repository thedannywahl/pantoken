...
- [drawer-layout.tray](/sl/api/css/drawer-layout.tray.md)
- [tray](/sl/api/css/tray.md)

## Sorodno

- [tray](/sl/api/css/tray.md) — A standalone edge overlay; this layout keeps tray and content in the same flow.
- [context-view](/sl/api/css/context-view.md) — A smaller anchored surface for contextual actions and detail.
