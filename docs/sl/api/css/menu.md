...
- [menu.group](/sl/api/css/menu.group.md)
- [menu.item](/sl/api/css/menu.item.md)
- [menu.separator](/sl/api/css/menu.separator.md)
- [side-nav-bar.item](/sl/api/css/side-nav-bar.item.md)

## Sorodno

- [tree-browser](/sl/api/css/tree-browser.md) — Both present nested, selectable entries.
- [simple-select](/sl/api/css/simple-select.md) — A select's dropdown reuses this menu surface.
