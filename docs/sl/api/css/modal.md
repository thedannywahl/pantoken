...
- [modal.body](/sl/api/css/modal.body.md)
- [modal.footer](/sl/api/css/modal.footer.md)
- [modal.header](/sl/api/css/modal.header.md)

## Sorodno

- [tray](/sl/api/css/tray.md) — A tray is the same dismissible overlay pattern, anchored to a screen edge.
