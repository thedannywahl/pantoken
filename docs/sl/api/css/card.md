...
- [heading](/sl/api/css/heading.md) — Place directly in the card or inside a container section.
- [button](/sl/api/css/button.md) — Place directly in the card or inside a container section.
- [img](/sl/api/css/img.md) — Place directly in the card as a media region.
- [badge](/sl/api/css/badge.md) — Place directly in the card as a status indicator.
