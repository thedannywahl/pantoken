...
| `.-size-regular` | <span class="instui-pill -color-danger pantoken-doc-tag">Zastarelo</span> — use `.-size-md`. |
| `.-size-sm` | Small. |
...
- [modal](/sl/api/css/modal.md) — The same dismissible overlay pattern, centred instead of edge-pinned.
- [popover](/sl/api/css/popover.md) — The generic top-layer surface this builds on.
