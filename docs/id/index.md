...
features:
  ...
  - icon:
    ...
    title: Gunakan paket terkecil
    details: Pasang hanya @pantoken/css untuk stylesheet, @pantoken/react untuk hooks dan ikon, atau preset bundler untuk Tailwind, Panda, atau MUI.
  - icon:
