...
| `.-size-regular` | <span class="instui-pill -color-danger pantoken-doc-tag">Tidak disarankan</span> — use `.-size-md`. |
| `.-size-sm` | Small. |
...
- [modal](/id/api/css/modal.md) — The same dismissible overlay pattern, centred instead of edge-pinned.
- [popover](/id/api/css/popover.md) — The generic top-layer surface this builds on.
