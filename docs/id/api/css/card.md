...
- [heading](/id/api/css/heading.md) — Place directly in the card or inside a container section.
- [button](/id/api/css/button.md) — Place directly in the card or inside a container section.
- [img](/id/api/css/img.md) — Place directly in the card as a media region.
- [badge](/id/api/css/badge.md) — Place directly in the card as a status indicator.
