...
| `.-render-icon-<name>` | <span class="instui-pill -color-danger pantoken-doc-tag">Tidak disarankan</span> — The former `renderIcon` prop; still works as an alias, but use `-icon-<name>` instead. |
...
- [badge](/id/api/css/badge.md) — A badge is the count or notification counterpart.
- [tag](/id/api/css/tag.md) — A tag is the removable, form-oriented counterpart.
