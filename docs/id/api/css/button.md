...
| `.-color-primary-inverse` | <span class="instui-pill -color-danger pantoken-doc-tag">Tidak disarankan</span> — use `.-on-color`. |
...
- [close-button](/id/api/css/close-button.md) — The icon-only dismiss button.
