...
| --- | --- |
| `.-color-ai` | <span class="instui-pill -color-danger pantoken-doc-tag">Tidak disarankan</span> — use `.-color-ai-highlight`. |
...
- [heading](/id/api/css/heading.md) — Typography for headings rather than body text.
- [truncate](/id/api/css/truncate.md) — Clips this text to one line or a set number of lines.
