...
- [drawer-layout.content](/id/api/css/drawer-layout.content.md)
- [drawer-layout.tray](/id/api/css/drawer-layout.tray.md)
- [tray](/id/api/css/tray.md)

## Terkait

- [tray](/id/api/css/tray.md) — A standalone edge overlay; this layout keeps tray and content in the same flow.
- [context-view](/id/api/css/context-view.md) — A smaller anchored surface for contextual actions and detail.
