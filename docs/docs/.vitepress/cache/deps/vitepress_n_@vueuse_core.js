import {
  ...
  xt as inject,
  zt as onUnmounted,
} from "./vue.runtime.esm-bundler-7USM7TRw.js";
...
function createDisposableDirective(origin = {}) {
  ...
  return {
    ...
    mounted(el, binding, vNode, prevNode) {
      ...
      const scope =
        (_scopeWeakMap$get = scopeWeakMap.get(el)) !== null && _scopeWeakMap$get !== void 0
          ? _scopeWeakMap$get
          : effectScope();
...
function useArrayIncludes(...args) {
  ...
  comparator =
    (_comparator = comparator) !== null && _comparator !== void 0
      ? _comparator
      : (element, value) => element === toValue(value);
  return computed(() =>
    toValue(list)
      .slice(formIndex)
        ...
        (event) => {
          setTimeout(() => {
            ...
            if (
              ...
              !(el === null || el === void 0 ? void 0 : el.contains(window.document.activeElement))
            )
              handler(event);
          }, 0);
        },
...
function onElementRemoval(target, callback, options = {}) {
  const {
    window = defaultWindow,
    document = window === null || window === void 0 ? void 0 : window.document,
    flush = "sync",
  } = options;
...
function useBluetooth(options) {
  ...
  async function requestDevice() {
    ...
    try {
      device.value = await (navigator === null || navigator === void 0
        ? void 0
...
function useBrowserLocation(options = {}) {
  ...
  const buildState = (trigger) => {
    ...
    const { state, length } =
      (window === null || window === void 0 ? void 0 : window.history) || {};
...
function useCssVar(prop, target, options = {}) {
  ...
  function updateCssVar() {
    ...
    if (el && window && key) {
      ...
      const value =
        (_window$getComputedSt = window.getComputedStyle(el).getPropertyValue(key)) === null ||
...
function useCycleList(list, options) {
  ...
  const index = computed({
    get() {
      ...
      let index = (options === null || options === void 0 ? void 0 : options.getIndexOf)
  ...
  const mode = useColorMode({
    ...
    onChanged: (mode, defaultHandler) => {
      ...
      if (options.onChanged)
        (_options$onChanged = options.onChanged) === null ||
          _options$onChanged === void 0 ||
          _options$onChanged.call(options, mode === "dark", defaultHandler, mode);
...
function useDisplayMedia(options = {}) {
  ...
  const isSupported = /* @__PURE__ */ useSupported(() => {
    ...
    return navigator === null ||
      navigator === void 0 ||
      (_navigator$mediaDevic = navigator.mediaDevices) === null ||
  ...
  const handleAutoScroll = (container, targetRect, position) => {
    ...
    if (scrollSettings.direction === "x" || scrollSettings.direction === "both") {
      if (position.x < marginX && scrollLeft > 0) deltaX = -speedX;
        ...
        position.x + targetRect.width > clientWidth - marginX &&
    ...
    if (scrollSettings.direction === "y" || scrollSettings.direction === "both") {
      if (position.y < marginY && scrollTop > 0) deltaY = -speedY;
        ...
        position.y + targetRect.height > clientHeight - marginY &&
...
function useDropZone(target, options = {}) {
  ...
  if (isClient) {
    ...
    const checkValidity = (items) => {
      ...
      const types = Array.from(items !== null && items !== void 0 ? items : []).map(
        (item) => item.type,
      );
      ...
      element.value = toValue(multiple)
        ? (_document$elementsFro =
            document === null || document === void 0
              ? void 0
              : document.elementsFromPoint(toValue(x), toValue(y))) !== null &&
  ...
  if (observeMutation) {
    ...
    useMutationObserver(
      ...
      (entries, observer) => {
        const el = targetEl.value;
        if (el) update(el);
        onMutationUpdated === null ||
          onMutationUpdated === void 0 ||
...
function useFavicon(newIcon = null, options = {}) {
  ...
  const applyIcon = (icon) => {
    ...
    if (!elements || elements.length === 0) {
      const link =
        document === null || document === void 0 ? void 0 : document.createElement("link");
      if (link) {
        link.rel = rel;
    ...
    return (payload, payloadType) => {
      if (!isFetching.value) {
        ...
        if (isRef(config.payload))
          watch([refetch, toRef(config.payload)], ([refetch]) => refetch && execute(), {
            deep: true,
          });
        return {
          ...shell,
...
function useFullscreen(target, options = {}) {
  ...
  const isCurrentElementFullScreen = () => {
    if (fullscreenElementMethod)
      return (
        (document === null || document === void 0 ? void 0 : document[fullscreenElementMethod]) ===
        targetRef.value
      );
    return false;
  };
  const isElementFullScreen = () => {
    if (fullscreenEnabled.value)
      if (document && document[fullscreenEnabled.value] != null)
        ...
        if (
          (target === null || target === void 0 ? void 0 : target[fullscreenEnabled.value]) != null
        )
  ...
  async function exit() {
    ...
    if (exitMethod.value)
      if ((document === null || document === void 0 ? void 0 : document[exitMethod.value]) != null)
        await document[exitMethod.value]();
      else {
        const target = targetRef.value;
        if ((target === null || target === void 0 ? void 0 : target[exitMethod.value]) != null)
  ...
  async function enter() {
    ...
    if (
      requestMethod.value &&
      (target === null || target === void 0 ? void 0 : target[requestMethod.value]) != null
    ) {
...
function useGamepad(options = {}) {
  ...
  const updateGamepadState = () => {
    const _gamepads =
      (navigator === null || navigator === void 0 ? void 0 : navigator.getGamepads()) || [];
...
function useScroll(element, options = {}) {
  ...
  function scrollTo(_x, _y) {
    ...
    if (!_element) return;
    (_ref = _element instanceof Document ? window.document.body : _element) === null ||
      _ref === void 0 ||
      _ref.scrollTo({
...
function usePointerLock(target, options = {}) {
  const { document = defaultDocument } = options;
  const isSupported = /* @__PURE__ */ useSupported(
    () => document && "pointerLockElement" in document,
  );
  ...
  if (isSupported.value) {
    ...
    useEventListener(
      ...
      () => {
        ...
        const currentElement =
          (_pointerLockElement = document.pointerLockElement) !== null &&
    ...
    useEventListener(
      ...
      () => {
        ...
        const currentElement =
          (_pointerLockElement2 = document.pointerLockElement) !== null &&
...
function useSessionStorage(key, initialValue, options = {}) {
  ...
  return useStorage(
    key,
    initialValue,
    window === null || window === void 0 ? void 0 : window.sessionStorage,
    options,
  );
}
/**
...
function useStyleTag(css, options = {}) {
  ...
  const load = () => {
    ...
    _refCount.set(
      el,
      ((_refCount$get = _refCount.get(el)) !== null && _refCount$get !== void 0
        ? _refCount$get
        : 0) + 1,
    );
    stop = watch(
  ...
  const unload = () => {
    ...
    if (el) {
      var _refCount$get2;
      const count =
        ((_refCount$get2 = _refCount.get(el)) !== null && _refCount$get2 !== void 0
          ? _refCount$get2
          : 1) - 1;
      if (count <= 0) {
        _refCount.delete(el);
...
function useTextDirection(options = {}) {
  ...
  return computed({
    ...
    set(v) {
      ...
      if (!document) return;
      if (dir.value)
        (_document$querySelect2 = document.querySelector(selector)) === null ||
          _document$querySelect2 === void 0 ||
          _document$querySelect2.setAttribute("dir", dir.value);
      else
        (_document$querySelect3 = document.querySelector(selector)) === null ||
...
function useTextSelection(options = {}) {
  ...
  const selection = shallowRef(
    (_window$getSelection =
      window === null || window === void 0 ? void 0 : window.getSelection()) !== null &&
...
function useTitle(newTitle = null, options = {}) {
  ...
  const originalTitle =
    (_document$title = document === null || document === void 0 ? void 0 : document.title) !==
  ...
  const title = toRef(
    (_ref =
      newTitle !== null && newTitle !== void 0
        ...
        : document === null || document === void 0
          ? void 0
          : document.title) !== null && _ref !== void 0
      ? _ref
      : null,
  );
  ...
  watch(
    ...
    (newValue, oldValue) => {
      if (newValue !== oldValue && document)
        document.title = format(newValue !== null && newValue !== void 0 ? newValue : "");
    },
    { immediate: true },
  );
  if (options.observe && !options.titleTemplate && document && !isReadonly) {
    var _document$head;
    useMutationObserver(
      (_document$head = document.head) === null || _document$head === void 0
        ? void 0
...
function createScrollTo(type, calculateRange, getDistance, containerRef, itemSize) {
  return (index, options = defaultScrollToOptions) => {
    ...
    if (axisToCheck) {
      const containerSize =
        type === "horizontal" ? containerRef.value.clientWidth : containerRef.value.clientHeight;
  ...
  if (isSupported.value) {
    ...
    whenever(
      () =>
        ...
        (document === null || document === void 0 ? void 0 : document.visibilityState) ===
          "visible" &&
        requestedType.value,
      (type) => {
