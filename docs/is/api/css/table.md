...
- [table.body](/is/api/css/table.body.md)
- [table.cell](/is/api/css/table.cell.md)
- [table.col-header](/is/api/css/table.col-header.md)
- [table.head](/is/api/css/table.head.md)
- [table.row](/is/api/css/table.row.md)
- [table.row-header](/is/api/css/table.row-header.md)
