...
- [modal.body](/is/api/css/modal.body.md)
- [modal.footer](/is/api/css/modal.footer.md)
- [modal.header](/is/api/css/modal.header.md)

## Tengdar

- [tray](/is/api/css/tray.md) — A tray is the same dismissible overlay pattern, anchored to a screen edge.
