...
- [drawer-layout.content](/is/api/css/drawer-layout.content.md)
- [drawer-layout.tray](/is/api/css/drawer-layout.tray.md)
- [tray](/is/api/css/tray.md)

## Tengdar

- [tray](/is/api/css/tray.md) — A standalone edge overlay; this layout keeps tray and content in the same flow.
- [context-view](/is/api/css/context-view.md) — A smaller anchored surface for contextual actions and detail.
