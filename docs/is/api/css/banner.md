...
- [alert](/is/api/css/alert.md) — A non-dismissible, status-coloured counterpart for inline messages.
- [close-button](/is/api/css/close-button.md) — The dismiss control a banner may include.
