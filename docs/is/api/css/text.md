...
| Breyti | Lýsing |
| --- | --- |
| `.-color-ai` | <span class="instui-pill -color-danger pantoken-doc-tag">Úrelt</span> — use `.-color-ai-highlight`. |
...
- [heading](/is/api/css/heading.md) — Typography for headings rather than body text.
- [truncate](/is/api/css/truncate.md) — Clips this text to one line or a set number of lines.
