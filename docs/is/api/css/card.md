...
- [heading](/is/api/css/heading.md) — Place directly in the card or inside a container section.
- [button](/is/api/css/button.md) — Place directly in the card or inside a container section.
- [img](/is/api/css/img.md) — Place directly in the card as a media region.
- [badge](/is/api/css/badge.md) — Place directly in the card as a status indicator.
