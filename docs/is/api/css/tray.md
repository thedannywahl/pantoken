...
| `.-size-regular` | <span class="instui-pill -color-danger pantoken-doc-tag">Úrelt</span> — use `.-size-md`. |
| `.-size-sm` | Small. |
...
- [modal](/is/api/css/modal.md) — The same dismissible overlay pattern, centred instead of edge-pinned.
- [popover](/is/api/css/popover.md) — The generic top-layer surface this builds on.
