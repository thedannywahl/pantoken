...
- [text](/is/api/css/text.md)

## Tengdar

- [tooltip](/is/api/css/tooltip.md) — A tooltip is a smaller, hover- or focus-triggered anchored surface.
- [context-view](/is/api/css/context-view.md) — Context view is a related anchored surface with a pointer.
