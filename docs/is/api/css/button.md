...
| `.-color-primary-inverse` | <span class="instui-pill -color-danger pantoken-doc-tag">Úrelt</span> — use `.-on-color`. |
...
- [close-button](/is/api/css/close-button.md) — The icon-only dismiss button.
