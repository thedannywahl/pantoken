...
| `.-render-icon-<name>` | <span class="instui-pill -color-danger pantoken-doc-tag">Úrelt</span> — The former `renderIcon` prop; still works as an alias, but use `-icon-<name>` instead. |
...
- [badge](/is/api/css/badge.md) — A badge is the count or notification counterpart.
- [tag](/is/api/css/tag.md) — A tag is the removable, form-oriented counterpart.
