...
- [heading](/nn/api/css/heading.md) — Place directly in the card or inside a container section.
- [button](/nn/api/css/button.md) — Place directly in the card or inside a container section.
- [img](/nn/api/css/img.md) — Place directly in the card as a media region.
- [badge](/nn/api/css/badge.md) — Place directly in the card as a status indicator.
