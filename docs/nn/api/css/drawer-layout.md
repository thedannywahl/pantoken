...
- [drawer-layout.content](/nn/api/css/drawer-layout.content.md)
- [drawer-layout.tray](/nn/api/css/drawer-layout.tray.md)
- [tray](/nn/api/css/tray.md)

## Relatert

- [tray](/nn/api/css/tray.md) — A standalone edge overlay; this layout keeps tray and content in the same flow.
- [context-view](/nn/api/css/context-view.md) — A smaller anchored surface for contextual actions and detail.
