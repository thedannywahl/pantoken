...
| `.-color-primary-inverse` | <span class="instui-pill -color-danger pantoken-doc-tag">Utdatert</span> — use `.-on-color`. |
...
- [close-button](/nn/api/css/close-button.md) — The icon-only dismiss button.
