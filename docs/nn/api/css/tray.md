...
| `.-size-regular` | <span class="instui-pill -color-danger pantoken-doc-tag">Utdatert</span> — use `.-size-md`. |
| `.-size-sm` | Small. |
...
- [modal](/nn/api/css/modal.md) — The same dismissible overlay pattern, centred instead of edge-pinned.
- [popover](/nn/api/css/popover.md) — The generic top-layer surface this builds on.
