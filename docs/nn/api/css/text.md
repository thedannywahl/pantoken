...
| --- | --- |
| `.-color-ai` | <span class="instui-pill -color-danger pantoken-doc-tag">Utdatert</span> — use `.-color-ai-highlight`. |
...
- [heading](/nn/api/css/heading.md) — Typography for headings rather than body text.
- [truncate](/nn/api/css/truncate.md) — Clips this text to one line or a set number of lines.
