...
- [menu.group](/nn/api/css/menu.group.md)
- [menu.item](/nn/api/css/menu.item.md)
- [menu.separator](/nn/api/css/menu.separator.md)
- [side-nav-bar.item](/nn/api/css/side-nav-bar.item.md)

## Relatert

- [tree-browser](/nn/api/css/tree-browser.md) — Both present nested, selectable entries.
- [simple-select](/nn/api/css/simple-select.md) — A select's dropdown reuses this menu surface.
