...
<!-- js-requirement -->
> [!TIP]
> **JS-forbetring** — This component's CSS renders and works on its own; pair it with `@pantoken/interactions` to add the interactive behavior. See the [modifier table below](#modifiers).
...
- [modal.body](/nn/api/css/modal.body.md)
- [modal.footer](/nn/api/css/modal.footer.md)
- [modal.header](/nn/api/css/modal.header.md)

## Relatert

- [tray](/nn/api/css/tray.md) — A tray is the same dismissible overlay pattern, anchored to a screen edge.
