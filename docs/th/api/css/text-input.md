...
- [text-area](/th/api/css/text-area.md) — The multi-line counterpart with the same states and sizes.
- [number-input](/th/api/css/number-input.md) — The numeric-entry input sharing this chrome.
- [simple-select](/th/api/css/simple-select.md) — The native select sharing this field chrome.
- [input-group](/th/api/css/input-group.md) — Wraps this input with leading and trailing slots.
