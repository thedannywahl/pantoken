...
| --- | --- |
| `.-color-ai` | <span class="instui-pill -color-danger pantoken-doc-tag">เลิกใช้</span> — use `.-color-ai-highlight`. |
...
- [heading](/th/api/css/heading.md) — Typography for headings rather than body text.
- [truncate](/th/api/css/truncate.md) — Clips this text to one line or a set number of lines.
