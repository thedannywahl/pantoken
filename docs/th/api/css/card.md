...
- [heading](/th/api/css/heading.md) — Place directly in the card or inside a container section.
- [button](/th/api/css/button.md) — Place directly in the card or inside a container section.
- [img](/th/api/css/img.md) — Place directly in the card as a media region.
- [badge](/th/api/css/badge.md) — Place directly in the card as a status indicator.
