...
- [modal.body](/th/api/css/modal.body.md)
- [modal.footer](/th/api/css/modal.footer.md)
- [modal.header](/th/api/css/modal.header.md)

## ที่เกี่ยวข้อง

- [tray](/th/api/css/tray.md) — A tray is the same dismissible overlay pattern, anchored to a screen edge.
