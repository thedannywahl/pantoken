...
- [drawer-layout.tray](/th/api/css/drawer-layout.tray.md)
- [tray](/th/api/css/tray.md)

## ที่เกี่ยวข้อง

- [tray](/th/api/css/tray.md) — A standalone edge overlay; this layout keeps tray and content in the same flow.
- [context-view](/th/api/css/context-view.md) — A smaller anchored surface for contextual actions and detail.
