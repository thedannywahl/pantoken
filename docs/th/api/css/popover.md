...
- [text](/th/api/css/text.md)

## ที่เกี่ยวข้อง

- [tooltip](/th/api/css/tooltip.md) — A tooltip is a smaller, hover- or focus-triggered anchored surface.
- [context-view](/th/api/css/context-view.md) — Context view is a related anchored surface with a pointer.
