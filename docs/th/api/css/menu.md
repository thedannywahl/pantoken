...
- [menu.group](/th/api/css/menu.group.md)
- [menu.item](/th/api/css/menu.item.md)
- [menu.separator](/th/api/css/menu.separator.md)
- [side-nav-bar.item](/th/api/css/side-nav-bar.item.md)

## ที่เกี่ยวข้อง

- [tree-browser](/th/api/css/tree-browser.md) — Both present nested, selectable entries.
- [simple-select](/th/api/css/simple-select.md) — A select's dropdown reuses this menu surface.
