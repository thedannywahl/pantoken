...
| `.-color-primary-inverse` | <span class="instui-pill -color-danger pantoken-doc-tag">เลิกใช้</span> — use `.-on-color`. |
...
- [close-button](/th/api/css/close-button.md) — The icon-only dismiss button.
