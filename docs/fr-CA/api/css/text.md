...
| --- | --- |
| `.-color-ai` | <span class="instui-pill -color-danger pantoken-doc-tag">Obsolète</span> — use `.-color-ai-highlight`. |
...
- [heading](/fr-CA/api/css/heading.md) — Typography for headings rather than body text.
- [truncate](/fr-CA/api/css/truncate.md) — Clips this text to one line or a set number of lines.
