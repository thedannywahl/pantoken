...
- [heading](/fr-CA/api/css/heading.md) — Place directly in the card or inside a container section.
- [button](/fr-CA/api/css/button.md) — Place directly in the card or inside a container section.
- [img](/fr-CA/api/css/img.md) — Place directly in the card as a media region.
- [badge](/fr-CA/api/css/badge.md) — Place directly in the card as a status indicator.
