...
- [menu.group](/fr-CA/api/css/menu.group.md)
- [menu.item](/fr-CA/api/css/menu.item.md)
- [menu.separator](/fr-CA/api/css/menu.separator.md)
- [side-nav-bar.item](/fr-CA/api/css/side-nav-bar.item.md)

## Connexe

- [tree-browser](/fr-CA/api/css/tree-browser.md) — Both present nested, selectable entries.
- [simple-select](/fr-CA/api/css/simple-select.md) — A select's dropdown reuses this menu surface.
