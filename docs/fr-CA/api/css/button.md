...
| `.-color-primary-inverse` | <span class="instui-pill -color-danger pantoken-doc-tag">Obsolète</span> — use `.-on-color`. |
...
- [close-button](/fr-CA/api/css/close-button.md) — The icon-only dismiss button.
