...
| `.-size-regular` | <span class="instui-pill -color-danger pantoken-doc-tag">Obsolète</span> — use `.-size-md`. |
| `.-size-sm` | Small. |
...
- [modal](/fr-CA/api/css/modal.md) — The same dismissible overlay pattern, centred instead of edge-pinned.
- [popover](/fr-CA/api/css/popover.md) — The generic top-layer surface this builds on.
