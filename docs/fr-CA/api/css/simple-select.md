...
- [text-input](/fr-CA/api/css/text-input.md) — Shares the same field chrome, states, and sizes.
- [menu](/fr-CA/api/css/menu.md) — The dropdown surface a richer select reuses.
