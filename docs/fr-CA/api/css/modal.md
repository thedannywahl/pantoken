...
- [modal.body](/fr-CA/api/css/modal.body.md)
- [modal.footer](/fr-CA/api/css/modal.footer.md)
- [modal.header](/fr-CA/api/css/modal.header.md)

## Connexe

- [tray](/fr-CA/api/css/tray.md) — A tray is the same dismissible overlay pattern, anchored to a screen edge.
