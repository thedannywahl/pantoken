...
hero:
  ...
  actions:
    - theme: brand
      text: Premiers pas
      link: /fr-CA/guide/getting-started
    - theme: alt
      text: Carte des paquets
      link: /fr-CA/guide/packages
    - theme: alt
...
features:
  ...
  - icon:
    ...
    title: Utilisez le plus petit paquet
    details: Installez simplement @pantoken/css pour une feuille de style, @pantoken/react pour les hooks et les icônes, ou un preset de bundler pour Tailwind, Panda ou MUI.
  - icon:
