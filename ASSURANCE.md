...
8. **Generated GitHub source archives.** GitHub can verify an immutable release tag and attached
   assets, but its automatically generated source archives are not attached assets. npm packages are
   separately covered by registry signatures and Sigstore provenance.
